...
use openstack_sdk_core::types::EntryStatus;
...
use crate::cli::{CliArgs, OutputFormat, TableArrangement};
...
impl OutputProcessor {
    ...
    pub fn from_args<C: CliArgs, R: AsRef<str>, A: AsRef<str>>(
        args: &C,
    ...
    pub fn validate_args<C: CliArgs>(&self, _args: &C) -> Result<(), OpenStackCliError> {
        Ok(())
    }
