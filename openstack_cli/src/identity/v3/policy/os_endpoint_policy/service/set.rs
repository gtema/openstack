...
//! Set Service command
//!
//! Wraps invoking of the `v3/policies/{policy_id}/OS-ENDPOINT-POLICY/services/{service_id}` with `PUT` method
...
use openstack_sdk::api::identity::v3::policy::os_endpoint_policy::service::set;
use openstack_types::identity::v3::policy::os_endpoint_policy::service::response::set::ServiceResponse;
