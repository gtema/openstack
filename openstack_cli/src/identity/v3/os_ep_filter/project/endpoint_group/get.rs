...
//! Get EndpointGroup command
//!
//! Wraps invoking of the `v3/OS-EP-FILTER/projects/{project_id}/endpoint_groups` with `GET` method
...
use openstack_sdk::api::identity::v3::os_ep_filter::project::endpoint_group::get;
use openstack_sdk::api::identity::v3::project::find as find_project;
use openstack_types::identity::v3::os_ep_filter::project::endpoint_group::response::get::EndpointGroupResponse;
use tracing::warn;
...
impl EndpointGroupCommand {
    ...
    pub async fn take_action(
        ...
        info!("Get EndpointGroup");

        let op = OutputProcessor::from_args(
            parsed_args,
            Some("identity.OS_EP_FILTER/project/endpoint_group"),
            Some("get"),
        );
