...
//!
//! Wraps invoking of the `v3/OS-EP-FILTER/projects/{project_id}/endpoints/{endpoint_id}` with `GET` method
...
use openstack_sdk::api::identity::v3::os_ep_filter::project::endpoint::get;
use openstack_sdk::api::identity::v3::project::find as find_project;
use openstack_types::identity::v3::os_ep_filter::project::endpoint::response::get::EndpointResponse;
use tracing::warn;
