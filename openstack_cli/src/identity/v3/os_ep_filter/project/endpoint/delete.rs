...
//!
//! Wraps invoking of the `v3/OS-EP-FILTER/projects/{project_id}/endpoints/{endpoint_id}` with `DELETE` method
...
use openstack_sdk::api::identity::v3::os_ep_filter::project::endpoint::delete;
