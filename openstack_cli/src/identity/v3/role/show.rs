...
use openstack_types::identity::v3::role::response::get::RoleResponse;
...
impl RoleCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("identity.role"), Some("show"));
        ...
        op.output_single::<RoleResponse>(find_data)?;
        Ok(())
    }
}
