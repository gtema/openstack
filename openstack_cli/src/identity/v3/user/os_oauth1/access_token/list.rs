...
//! List AccessTokens command
//!
//! Wraps invoking of the `v3/users/{user_id}/OS-OAUTH1/access_tokens` with `GET` method
...
use openstack_types::identity::v3::user::os_oauth1::access_token::response::list::AccessTokenResponse;
use tracing::warn;
