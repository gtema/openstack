...
//! Delete Role command
//!
//! Wraps invoking of the `v3/domains/{domain_id}/groups/{group_id}/roles/{role_id}` with `DELETE` method
...
#[derive(Args)]
#[command(about = "Unassign role from group on domain")]
...
impl RoleCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args_with_resource_key(parsed_args, "identity.domain/group/role");
