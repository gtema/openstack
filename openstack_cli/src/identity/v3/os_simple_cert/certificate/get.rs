...
//!
//! Wraps invoking of the `v3/OS-SIMPLE-CERT/certificates` with `GET` method
...
use openstack_sdk::api::identity::v3::os_simple_cert::certificate::get;
use openstack_types::identity::v3::os_simple_cert::certificate::response::get::CertificateResponse;
