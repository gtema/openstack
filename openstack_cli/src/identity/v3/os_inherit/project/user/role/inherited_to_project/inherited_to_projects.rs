...
//!
//! Wraps invoking of the `v3/OS-INHERIT/projects/{project_id}/users/{user_id}/roles/{role_id}/inherited_to_projects` with `PUT` method
...
use openstack_types::identity::v3::os_inherit::project::user::role::inherited_to_project::response::inherited_to_projects::InheritedToProjectResponse;
...
/// operation
#[derive(Args)]
#[command(about = "Assign role to user on projects in a subtree")]
