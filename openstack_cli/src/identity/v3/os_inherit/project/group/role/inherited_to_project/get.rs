...
//!
//! Wraps invoking of the `v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects` with `GET` method
...
use openstack_types::identity::v3::os_inherit::project::group::role::inherited_to_project::response::get::InheritedToProjectResponse;
use tracing::warn;
