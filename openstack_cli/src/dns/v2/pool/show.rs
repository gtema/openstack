...
//! Show Pool command
//!
//! Wraps invoking of the `v2/pools/{pool_id}` with `GET` method
...
use openstack_sdk::api::dns::v2::pool::get;
use openstack_types::dns::v2::pool::response::get::PoolResponse;
...
impl PoolCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("dns.pool"), Some("show"));
