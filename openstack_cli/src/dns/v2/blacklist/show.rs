...
//! Show Blacklist command
//!
//! Wraps invoking of the `v2/blacklists/{blacklist_id}` with `GET` method
...
use openstack_sdk::api::dns::v2::blacklist::get;
use openstack_types::dns::v2::blacklist::response::get::BlacklistResponse;

/// Show a blacklist
#[derive(Args)]
#[command(about = "Show Blacklist")]
...
impl BlacklistCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("dns.blacklist"), Some("show"));
