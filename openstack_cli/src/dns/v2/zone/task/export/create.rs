...
//!
//! Wraps invoking of the `v2/zones/{zone_id}/tasks/export` with `POST` method
...
/// Export a zone.
#[derive(Args)]
#[command(about = "Create a Zone Export")]
...
impl ExportCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("dns.zone/task/export"), Some("create"));
