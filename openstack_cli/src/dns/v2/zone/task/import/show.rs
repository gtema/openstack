...
//! Show Import command
//!
//! Wraps invoking of the `v2/zones/tasks/imports/{import_id}` with `GET` method
...
use openstack_sdk::api::dns::v2::zone::task::import::get;
use openstack_types::dns::v2::zone::task::import::response::get::ImportResponse;
...
struct PathParameters {
    /// import_id parameter for /v2/zones/tasks/imports/{import_id} API
    #[arg(
...
impl ImportCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("dns.zone/task/import"), Some("show"));
