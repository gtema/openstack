...
//! Set TransferRequest command
//!
//! Wraps invoking of the `v2/zones/tasks/transfer_requests/{zone_transfer_request_id}` with `PATCH` method
...
use openstack_sdk::api::dns::v2::zone::task::transfer_request::set;
use openstack_types::dns::v2::zone::task::transfer_request::response::set::TransferRequestResponse;
use serde_json::Value;

/// Command without description in OpenAPI
#[derive(Args)]
#[command(about = "Update a Zone Transfer Request")]
