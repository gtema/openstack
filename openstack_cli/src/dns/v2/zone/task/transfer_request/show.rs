...
//! Show TransferRequest command
//!
//! Wraps invoking of the `v2/zones/tasks/transfer_requests/{zone_transfer_request_id}` with `GET` method
...
use openstack_sdk::api::dns::v2::zone::task::transfer_request::get;
use openstack_types::dns::v2::zone::task::transfer_request::response::get::TransferRequestResponse;

/// Command without description in OpenAPI
#[derive(Args)]
#[command(about = "Show a Zone Transfer Request")]
