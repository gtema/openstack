...
//! Action Task command
//!
//! Wraps invoking of the `v2/zones/{zone_id}/tasks/abandon` with `POST` method
...
use openstack_sdk::api::dns::v2::zone::task::abandon;
use openstack_sdk::api::find_by_name;
use openstack_types::dns::v2::zone::task::response::abandon::TaskResponse;
use serde_json::Value;
use tracing::warn;

/// Request of the zones/zone_id/tasks/abandon:post operation
#[derive(Args)]
#[command(about = "Abandon Zone")]
...
impl TaskCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "dns.zone/task");
