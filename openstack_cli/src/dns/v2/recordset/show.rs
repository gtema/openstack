...
//!
//! Wraps invoking of the `v2/recordsets/{recordset_id}` with `GET` method
...
struct PathParameters {
    /// recordset_id parameter for /v2/recordsets/{recordset_id} API
    #[arg(
...
impl RecordsetCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("dns.recordset"), Some("None"));
