...
//! Create ServerExternalEvent command [microversion = 2.93]
//!
...
///
#[derive(Args)]
#[command(about = "Run Events (microversion = 2.93)")]
...
impl ServerExternalEventCommand {
    ...
    pub async fn take_action(
        ...
        let mut ep_builder = create_293::Request::builder();
        ep_builder.header("OpenStack-API-Version", "compute 2.93");
        ...
        let events_builder: Vec<create_293::Events> = self
            .events
            .iter()
            .flat_map(|v| serde_json::from_value::<create_293::Events>(v.to_owned()))
            .collect::<Vec<create_293::Events>>();
