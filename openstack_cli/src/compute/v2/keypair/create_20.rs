...
//! Create Keypair command [microversion = 2.0]
//!
...
/// conflict(409)
#[derive(Args)]
#[command(about = "Import (or create) Keypair (microversion = 2.0)")]
...
impl KeypairCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.keypair"), Some("None"));
