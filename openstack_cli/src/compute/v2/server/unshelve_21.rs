...
use openstack_sdk::api::compute::v2::server::unshelve_21;
use serde_json::Value;

/// Command without description in OpenAPI
#[derive(Args)]
#[command(about = "Unshelve (Restore) Shelved Server (unshelve Action) (microversion = 2.1)")]
...
impl ServerCommand {
    ...
    pub async fn take_action(
        ...
        let mut ep_builder = unshelve_21::Request::builder();
        ep_builder.header(
