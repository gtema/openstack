...
use clap::ValueEnum;
use http::Response;
use openstack_sdk::api::compute::v2::server::rebuild_290;
use openstack_sdk::api::RawQueryAsync;
use structable_derive::StructTable;

#[derive(Args, Clone, Debug)]
#[command(about = "Rebuild Server (rebuild Action) (microversion = 2.90)")]
...
impl OSCCommand for ServerCmd {
    async fn take_action(
        ...
        let mut ep_builder = rebuild_290::Request::builder();
        ...
        let mut rebuild_builder = rebuild_290::RebuildBuilder::default();
        ...
        if let Some(val) = &args.os_dcf_disk_config {
            let tmp = match val {
                OsDcfDiskConfig::Auto => rebuild_290::OsDcfDiskConfig::Auto,
                OsDcfDiskConfig::Manual => rebuild_290::OsDcfDiskConfig::Manual,
            };
        ...
        if let Some(val) = &args.hostname {
            rebuild_builder.hostname(val.clone());
        }
