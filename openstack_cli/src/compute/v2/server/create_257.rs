...
#[command(about = "Create Server (microversion = 2.57)")]
...
impl OSCCommand for ServerCmd {
    async fn take_action(
        ...
        let mut ep_builder = create_257::Request::builder();
        ...
        let mut server_builder = create_257::ServerBuilder::default();
        ...
        if let Some(data) = &args.networks.networks {
            let networks_builder: Vec<create_257::Networks> = data
                .iter()
                .flat_map(|v| serde_json::from_value::<create_257::Networks>(v.clone()))
                .collect();
        ...
        if let Some(val) = &args.os_dcf_disk_config {
            let tmp = match val {
                OsDcfDiskConfig::Auto => create_257::OsDcfDiskConfig::Auto,
                OsDcfDiskConfig::Manual => create_257::OsDcfDiskConfig::Manual,
            };
        ...
        if let Some(val) = &args.block_device_mapping {
            let block_device_mapping_builder: Vec<create_257::BlockDeviceMapping> = val
                .iter()
                .flat_map(|v| serde_json::from_value::<create_257::BlockDeviceMapping>(v.clone()))
                .collect::<Vec<create_257::BlockDeviceMapping>>();
            server_builder.block_device_mapping(block_device_mapping_builder);
        }

        if let Some(val) = &args.block_device_mapping_v2 {
            let block_device_mapping_v2_builder: Vec<create_257::BlockDeviceMappingV2> = val
                .iter()
                .flat_map(|v| serde_json::from_value::<create_257::BlockDeviceMappingV2>(v.clone()))
                .collect::<Vec<create_257::BlockDeviceMappingV2>>();
        ...
        if let Some(val) = &args.security_groups {
            let security_groups_builder: Vec<create_257::SecurityGroups> = val
                .iter()
                .flat_map(|v| create_257::SecurityGroupsBuilder::default().name(v).build())
                .collect();
        ...
        if let Some(args) = &self.args.os_scheduler_hints {
            let mut os_scheduler_hints_builder = create_257::OsSchedulerHintsBuilder::default();
