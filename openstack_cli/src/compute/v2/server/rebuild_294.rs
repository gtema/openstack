...
use clap::ValueEnum;
use http::Response;
use openstack_sdk::api::compute::v2::server::rebuild_294;
use openstack_sdk::api::RawQueryAsync;
use structable_derive::StructTable;

#[derive(Args, Clone, Debug)]
#[command(about = "Rebuild Server (rebuild Action) (microversion = 2.94)")]
...
impl OSCCommand for ServerCmd {
    async fn take_action(
        ...
        let mut ep_builder = rebuild_294::Request::builder();
        ...
        if let Some(val) = &args.os_dcf_disk_config {
            let tmp = match val {
                ...
                OsDcfDiskConfig::Manual => rebuild_294::OsDcfDiskConfig::Manual,
            };
