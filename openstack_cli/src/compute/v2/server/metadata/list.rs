...
#[command(about = "List All Metadata")]
pub struct MetadatasArgs {
...
/// Metadatas list command
pub struct MetadatasCmd {
    pub args: MetadatasArgs,
}
...
#[async_trait]
impl OSCCommand for MetadatasCmd {
    async fn take_action(
        &self,
        parsed_args: &Cli,
        client: &mut AsyncOpenStack,
    ) -> Result<(), OpenStackCliError> {
        info!("List Metadatas with {:?}", self.args);
