...
#[command(about = "Rebuild Server (rebuild Action) (microversion = 2.1)")]
...
impl OSCCommand for ServerCmd {
    async fn take_action(
        ...
        let mut ep_builder = rebuild_21::Request::builder();
        ...
        let mut rebuild_builder = rebuild_21::RebuildBuilder::default();
        ...
        if let Some(val) = &args.os_dcf_disk_config {
            let tmp = match val {
                OsDcfDiskConfig::Auto => rebuild_21::OsDcfDiskConfig::Auto,
                OsDcfDiskConfig::Manual => rebuild_21::OsDcfDiskConfig::Manual,
            };
        ...
        if let Some(val) = &args.personality {
            let personality_builder: Vec<rebuild_21::Personality> = val
                .iter()
                .flat_map(|v| serde_json::from_value::<rebuild_21::Personality>(v.clone()))
                .collect::<Vec<rebuild_21::Personality>>();
