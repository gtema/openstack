...
use openstack_sdk::api::compute::v2::server::set_219;
...
#[command(about = "Update Server (microversion = 2.19)")]
...
impl OSCCommand for ServerCmd {
    async fn take_action(
        ...
        find_builder.header("OpenStack-API-Version", "compute 2.19");
        ...
        if let Some(val) = &args.os_dcf_disk_config {
            let tmp = match val {
                ...
                OsDcfDiskConfig::Manual => set_219::OsDcfDiskConfig::Manual,
            };
