...
use openstack_sdk::api::compute::v2::os_availability_zone::list_detailed;
...
pub struct OsAvailabilityZonesArgs {
...
/// OsAvailabilityZones list command
pub struct OsAvailabilityZonesCmd {
    pub args: OsAvailabilityZonesArgs,
}
/// OsAvailabilityZones response representation
...
#[async_trait]
impl Command for OsAvailabilityZonesCmd {
    async fn take_action(
        &self,
        parsed_args: &Cli,
        client: &mut AsyncOpenStack,
    ) -> Result<(), OpenStackCliError> {
        info!("List OsAvailabilityZones with {:?}", self.args);
