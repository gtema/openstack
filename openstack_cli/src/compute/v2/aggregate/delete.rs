...
//!
//! Wraps invoking of the `v2.1/os-aggregates/{id}` with `DELETE` method
...
impl AggregateCommand {
    ...
    pub async fn take_action(
        ...
        info!("Delete Aggregate");

        let op = OutputProcessor::from_args(parsed_args, Some("compute.aggregate"), Some("delete"));
