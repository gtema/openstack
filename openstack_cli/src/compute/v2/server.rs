...
mod rebuild_294;
mod remote_console;
mod remove_fixed_ip_21;
mod remove_floating_ip_21;
mod remove_security_group;
mod rescue;
mod reset_network;
mod resize;
mod restore;
