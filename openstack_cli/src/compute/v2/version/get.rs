...
//! Get Version command
//!
//! Wraps invoking of the `v2.1/` with `GET` method
...
/// API version, as well as information about supported min and max
/// microversions.
///
/// Normal Response Codes: 200
#[derive(Args)]
#[command(about = "List All Major Versions")]
...
impl VersionCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "compute.version");
