...
//! Set FloatingIpsBulk command
//!
//! Wraps invoking of the `v2.1/os-floating-ips-bulk/{id}` with `PUT` method
...
use openstack_types::compute::v2::floating_ips_bulk::response::set::FloatingIpsBulkResponse;
