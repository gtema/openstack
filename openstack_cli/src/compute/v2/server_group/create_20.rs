...
//! Create ServerGroup command [microversion = 2.0]
//!
...
use openstack_sdk::api::compute::v2::server_group::create_20;
...
/// conflict(409)
#[derive(Args)]
#[command(about = "Create Server Group (microversion = 2.0)")]
...
impl ServerGroupCommand {
    ...
    pub async fn take_action(
        ...
        let mut server_group_builder = create_20::ServerGroupBuilder::default();
        ...
        server_group_builder.policies(
            args.policies
                .iter()
                .map(|x| match x {
                    Policies::Affinity => create_20::Policies::Affinity,
                    Policies::AntiAffinity => create_20::Policies::AntiAffinity,
                })
                .collect::<Vec<_>>(),
        );
