...
use openstack_sdk::api::compute::v2::flavor::os_flavor_access::get;
use openstack_sdk::api::RawQueryAsync;

/// Command arguments
#[derive(Args, Clone, Debug)]
pub struct OsFlavorAccessArgs {
...
impl Command for OsFlavorAccessCmd {
    async fn take_action(
        ...
        info!("Get OsFlavorAccess with {:?}", self.args);
