...
//!
//! Wraps invoking of the `v2/lbaas/quotas/{project_id}` with `DELETE` method
...
impl QuotaCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("load-balancer.quota"), Some("delete"));
