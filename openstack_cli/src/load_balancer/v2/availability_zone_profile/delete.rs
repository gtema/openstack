...
//! Delete AvailabilityZoneProfile command
//!
//! Wraps invoking of the `v2/lbaas/availabilityzoneprofiles/{availabilityzoneprofile_id}` with `DELETE` method
...
use openstack_sdk::api::load_balancer::v2::availability_zone_profile::delete;
...
impl AvailabilityZoneProfileCommand {
    ...
    pub async fn take_action(
        ...
        info!("Delete AvailabilityZoneProfile");
