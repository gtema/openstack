...
use openstack_types::load_balancer::v2::l7policy::response::get::L7policyResponse;
...
impl L7PolicyCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("load-balancer.l7policy"), Some("show"));
