...
//! Delete Rule command
//!
//! Wraps invoking of the `v2/lbaas/l7policies/{l7policy_id}/rules/{rule_id}` with `DELETE` method
...
use openstack_sdk::api::load_balancer::v2::l7policy::rule::delete;
...
#[derive(Args)]
#[command(about = "Remove a L7 Rule")]
