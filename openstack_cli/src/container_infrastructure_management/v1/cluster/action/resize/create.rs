...
impl ResizeCommand {
    ...
    pub async fn take_action(
        ...
        ep_builder.node_count(self.node_count);
        ...
        // Set Request.nodes_to_remove data
        if let Some(arg) = &self.nodes_to_remove {
            ep_builder.nodes_to_remove(arg.iter().map(Into::into).collect::<Vec<_>>());
        }
