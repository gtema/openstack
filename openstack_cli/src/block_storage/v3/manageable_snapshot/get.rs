...
//! Get ManageableSnapshot command
//!
//! Wraps invoking of the `v3/manageable_snapshots` with `GET` method
...
struct ResponseData {
    ...
    #[structable(pretty, title = "manageable-snapshots")]
