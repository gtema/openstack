...
//! List ManageableVolumes command
//!
//! Wraps invoking of the `v3/manageable_volumes/detail` with `GET` method
...
///
#[derive(Args)]
pub struct ManageableVolumesCommand {
...
/// ManageableVolumes response representation
#[derive(Deserialize, Serialize, Clone, StructTable)]
struct ResponseData {
    /// A list of manageable volumes.
    ///
    #[serde(rename = "manageable-volumes")]
    #[structable(pretty, title = "manageable-volumes", wide)]
    manageable_volumes: Value,
}

impl ManageableVolumesCommand {
