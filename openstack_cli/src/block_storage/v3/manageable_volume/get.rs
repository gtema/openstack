...
//! Get ManageableVolume command
//!
//! Wraps invoking of the `v3/manageable_volumes` with `GET` method
...
struct ResponseData {
    ...
    #[structable(pretty, title = "manageable-volumes")]
