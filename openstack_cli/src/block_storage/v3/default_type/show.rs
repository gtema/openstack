...
use openstack_sdk::api::block_storage::v3::default_type::get;
use openstack_types::block_storage::v3::default_type::response::get::DefaultTypeResponse;
