...
//! List Consistencygroups command
//!
//! Wraps invoking of the `v3/consistencygroups/detail` with `GET` method
...
#[derive(Args)]
pub struct ConsistencygroupsCommand {
