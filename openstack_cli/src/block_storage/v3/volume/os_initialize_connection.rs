...
impl Command for VolumeCmd {
    async fn take_action(
        ...
        let args = &self.args.os_initialize_connection;
        let mut os_initialize_connection_builder =
            os_initialize_connection::OsInitializeConnectionBuilder::default();

        // let sub: os_initialize_connection

        ep_builder.os_initialize_connection(os_initialize_connection_builder.build().unwrap());
