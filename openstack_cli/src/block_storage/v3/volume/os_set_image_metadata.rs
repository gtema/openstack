...
pub struct VolumeArgs {
    ...
    #[command(flatten)]
    os_set_image_metadata: OsSetImageMetadata,
}
...
impl Command for VolumeCmd {
    async fn take_action(
        ...
        let mut ep_builder = os_set_image_metadata::Request::builder();

        // Set path parameters
        ep_builder.id(&self.args.path.id);
        // Set query parameters
        // Set body parameters
        // Set Request.os_set_image_metadata data
        let args = &self.args.os_set_image_metadata;
