...
use openstack_sdk::api::block_storage::v3::volume::os_roll_detaching;
...
impl Command for VolumeCmd {
    async fn take_action(
        ...
        // Set body parameters
        // Set Request.os_roll_detaching data
        let args = &self.args.os_roll_detaching;

        ep_builder.os_roll_detaching(args);
