...
//!
//! Wraps invoking of the `v3/volumes/{volume_id}/encryption` with `GET` method
...
use openstack_types::block_storage::v3::volume::encryption::response::list::EncryptionResponse;
