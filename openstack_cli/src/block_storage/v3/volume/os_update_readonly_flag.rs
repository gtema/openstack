...
use openstack_sdk::api::block_storage::v3::volume::os_update_readonly_flag;
...
impl Command for VolumeCmd {
    async fn take_action(
        ...
        let args = &self.args.os_update_readonly_flag;
        let mut os_update_readonly_flag_builder =
            os_update_readonly_flag::OsUpdateReadonlyFlagBuilder::default();
