...
use openstack_sdk::api::block_storage::v3::volume::os_reimage;
...
impl OSCCommand for VolumeCmd {
    async fn take_action(
        ...
        let mut ep_builder = os_reimage::Request::builder();
        ...
        let args = &self.args.os_reimage;

        ep_builder.os_reimage(args);
