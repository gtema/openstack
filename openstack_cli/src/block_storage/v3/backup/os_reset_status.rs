...
use openstack_sdk::api::block_storage::v3::backup::os_reset_status;
...
impl BackupCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("block-storage.backup"), Some("action"));
        ...
        ep_builder.os_reset_status(os_reset_status_builder.build().unwrap());
