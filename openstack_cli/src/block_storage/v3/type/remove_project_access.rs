...
use bytes::Bytes;
use http::Response;
use openstack_sdk::api::block_storage::v3::r#type::remove_project_access;
...
pub struct TypeCommand {
    ...
    #[command(flatten)]
    remove_project_access: RemoveProjectAccess,
}
...
impl TypeCommand {
    ...
    pub async fn take_action(
        ...
        let mut ep_builder = remove_project_access::Request::builder();

        // Set path parameters
        ep_builder.id(&self.path.id);
        // Set query parameters
        // Set body parameters
        // Set Request.remove_project_access data
        let args = &self.remove_project_access;
