...
use openstack_sdk::api::block_storage::v3::r#type::add_project_access;
...
pub struct TypeCommand {
    ...
    #[command(flatten)]
    add_project_access: AddProjectAccess,
}
...
impl TypeCommand {
    ...
    pub async fn take_action(
        ...
        ep_builder.add_project_access(
            add_project_access_builder
                .build()
