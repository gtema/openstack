...
//! Delete ExtraSpec command
//!
//! Wraps invoking of the `v3/types/{type_id}/extra_specs/{id}` with `DELETE` method
...
use openstack_sdk::api::block_storage::v3::r#type::extra_spec::delete;
