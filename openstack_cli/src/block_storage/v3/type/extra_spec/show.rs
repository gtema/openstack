...
//!
//! Wraps invoking of the `v3/types/{type_id}/extra_specs/{id}` with `GET` method
...
use openstack_types::block_storage::v3::r#type::extra_spec::response::get::ExtraSpecResponse;
