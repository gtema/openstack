...
//! Delete OsVolumeTransfer command
//!
//! Wraps invoking of the `v3/os-volume-transfer/{id}` with `DELETE` method
...
use openstack_sdk::api::block_storage::v3::os_volume_transfer::delete;
