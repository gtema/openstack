...
//! Get Version command
//!
//! Wraps invoking of the `` with `GET` method
...
use openstack_sdk::api::placement::v1::version::get;
use openstack_types::placement::v1::version::response::get::VersionResponse;
...
impl VersionCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "placement.version");
