...
//! Create Allocation command [microversion = 1.28]
//!
...
use openstack_sdk::api::placement::v1::allocation::create_128;
...
#[derive(Args)]
#[command(about = "Manage allocations (microversion = 1.28)")]
...
impl AllocationCommand {
    ...
    pub async fn take_action(
        ...
        let mut ep_builder = create_128::Request::builder();
        ep_builder.header(
