...
//! Json Images command
//!
//! Wraps invoking of the `v2/schemas/images` with `GET` method
...
#[derive(Args)]
#[command(about = "Show images schema")]
...
impl ImagesCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "image.schema/images");
