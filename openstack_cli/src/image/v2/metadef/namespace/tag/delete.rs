...
//! Delete Tag command
//!
//! Wraps invoking of the `v2/metadefs/namespaces/{namespace_name}/tags/{tag_name}` with `DELETE` method
...
use bytes::Bytes;
use http::Response;
use openstack_sdk::api::image::v2::metadef::namespace::tag::delete;
use openstack_sdk::api::RawQueryAsync;
use structable_derive::StructTable;

/// Deletes a tag definition within a namespace.
///
/// When you successfully delete a tag from a namespace, the response is empty
...
///
#[derive(Args)]
#[command(about = "Delete tag definition")]
