...
use openstack_types::image::v2::metadef::namespace::response::get::NamespaceResponse;
...
impl NamespaceCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("image.metadef/namespace"), Some("show"));
