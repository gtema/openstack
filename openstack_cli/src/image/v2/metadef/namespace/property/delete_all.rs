...
//!
//! Wraps invoking of the `v2/metadefs/namespaces/{namespace_name}/properties` with `DELETE` method
...
use openstack_sdk::api::image::v2::metadef::namespace::property::delete_all;
