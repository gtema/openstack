...
//! Show PortAssociation command
//!
//! Wraps invoking of the `v2.0/local_ips/{local_ip_id}/port_associations/{id}` with `GET` method
...
use openstack_types::network::v2::local_ip::port_association::response::get::PortAssociationResponse;
