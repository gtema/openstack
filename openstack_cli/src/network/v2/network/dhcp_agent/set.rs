...
//! Set DhcpAgent command
//!
//! Wraps invoking of the `v2.0/networks/{network_id}/dhcp-agents/{id}` with `PUT` method
...
use openstack_types::network::v2::network::dhcp_agent::response::set::DhcpAgentResponse;
