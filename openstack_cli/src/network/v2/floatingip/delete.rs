...
//!
//! Wraps invoking of the `v2.0/floatingips/{id}` with `DELETE` method
...
#[derive(Args)]
#[command(about = "Delete floating IP")]
...
impl FloatingipCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("network.floatingip"), Some("None"));
