...
//! List Tags command
//!
//! Wraps invoking of the `v2.0/ports/{port_id}/tags` with `GET` method
...
use openstack_types::network::v2::port::tag::response::list::TagResponse;
...
impl TagsCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("network.port/tag"), Some("list"));
