...
//! Show FloatingipPool command
//!
//! Wraps invoking of the `v2.0/floatingip-pools/{id}` with `GET` method
...
impl FloatingipPoolCommand {
    ...
    pub async fn take_action(
        ...
        info!("Show FloatingipPool");

        let op =
            OutputProcessor::from_args(parsed_args, Some("network.floatingip_pool"), Some("show"));
