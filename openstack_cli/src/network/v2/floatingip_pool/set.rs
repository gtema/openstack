...
//! Set FloatingipPool command
//!
//! Wraps invoking of the `v2.0/floatingip-pools/{id}` with `PUT` method
...
use openstack_sdk::api::network::v2::floatingip_pool::set;
use openstack_types::network::v2::floatingip_pool::response::set::FloatingipPoolResponse;
