...
use openstack_sdk::api::network::v2::network_segment_range::tag::replace;
use openstack_types::network::v2::network_segment_range::tag::response::replace::TagResponse;
