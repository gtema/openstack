...
//! List Tags command
//!
//! Wraps invoking of the `v2.0/network_segment_ranges/{network_segment_range_id}/tags` with `GET` method
...
use openstack_sdk::api::network::v2::network_segment_range::tag::list;
use openstack_sdk::api::{Pagination, paged};
use openstack_types::network::v2::network_segment_range::tag::response::list::TagResponse;
...
impl TagsCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(
            parsed_args,
            "network.network_segment_range/tag",
        );
