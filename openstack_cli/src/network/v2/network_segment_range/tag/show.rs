...
//! Show Tag command
//!
//! Wraps invoking of the `v2.0/network_segment_ranges/{network_segment_range_id}/tags/{id}` with `GET` method
...
use openstack_sdk::api::network::v2::network_segment_range::tag::get;
