...
//! List Tags command
//!
//! Wraps invoking of the `v2.0/subnets/{subnet_id}/tags` with `GET` method
...
use openstack_types::network::v2::subnet::tag::response::list::TagResponse;
...
impl TagsCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "network.subnet/tag");
