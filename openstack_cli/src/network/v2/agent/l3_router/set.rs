...
//! Set L3Router command
//!
//! Wraps invoking of the `v2.0/agents/{agent_id}/l3-routers/{id}` with `PUT` method
...
use openstack_sdk::api::network::v2::agent::l3_router::set;
...
impl L3RouterCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("network.agent/l3_router"), Some("set"));
