...
//! Set Tag command
//!
//! Wraps invoking of the `v2.0/policies/{policy_id}/tags` with `PUT` method
...
use openstack_sdk::api::network::v2::policy::tag::replace;
use openstack_types::network::v2::policy::tag::response::replace::TagResponse;
...
impl TagCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "network.policy/tag");
