...
//! List LoggableResources command
//!
//! Wraps invoking of the `v2.0/log/loggable-resources` with `GET` method
...
///
#[derive(Args)]
#[command(about = "List loggable resources")]
pub struct LoggableResourcesCommand {
...
/// LoggableResources response representation
