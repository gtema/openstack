...
//! Delete AliasBandwidthLimitRule command
//!
//! Wraps invoking of the `v2.0/qos/alias-bandwidth-limit-rules/{id}` with `DELETE` method
...
use bytes::Bytes;
use http::Response;
use openstack_sdk::api::network::v2::qos::alias_bandwidth_limit_rule::delete;
