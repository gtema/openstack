...
//! Show AliasMinimumBandwidthRule command
//!
//! Wraps invoking of the `v2.0/qos/alias-minimum-bandwidth-rules/{id}` with `GET` method
...
use openstack_types::network::v2::qos::alias_minimum_bandwidth_rule::response::get::AliasMinimumBandwidthRuleResponse;
...
impl AliasMinimumBandwidthRuleCommand {
    ...
    pub async fn take_action(
        ...
        info!("Show AliasMinimumBandwidthRule");
