...
//!
//! Wraps invoking of the `v2.0/routers/{id}/add_router_interface` with `PUT` method
...
use openstack_types::network::v2::router::response::add_router_interface::RouterResponse;

/// Request body
#[derive(Args)]
#[command(about = "Add interface to router")]
