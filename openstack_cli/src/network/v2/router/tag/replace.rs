...
//! Set Tag command
//!
//! Wraps invoking of the `v2.0/routers/{router_id}/tags` with `PUT` method
...
use openstack_types::network::v2::router::tag::response::replace::TagResponse;
...
impl TagCommand {
    ...
    pub async fn take_action(
        ...
        let op = OutputProcessor::from_args_with_resource_key(parsed_args, "network.router/tag");
