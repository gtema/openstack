...
//! List Tags command
//!
//! Wraps invoking of the `v2.0/subnetpools/{subnetpool_id}/tags` with `GET` method
...
use openstack_sdk::api::network::v2::subnetpool::tag::list;
use openstack_sdk::api::{Pagination, paged};
use openstack_types::network::v2::subnetpool::tag::response::list::TagResponse;
...
impl TagsCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("network.subnetpool/tag"), Some("list"));
