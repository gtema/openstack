...
//! Show Tag command
//!
//! Wraps invoking of the `v2.0/subnetpools/{subnetpool_id}/tags/{id}` with `GET` method
...
use openstack_sdk::api::network::v2::subnetpool::tag::get;
...
impl TagCommand {
    ...
    pub async fn take_action(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("network.subnetpool/tag"), Some("show"));
