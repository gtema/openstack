...
//! Action OnboardNetworkSubnet command
//!
//! Wraps invoking of the `v2.0/subnetpools/{id}/onboard_network_subnets` with `PUT` method
...
#[derive(Args)]
#[command(about = "Onboard subnets")]
pub struct OnboardNetworkSubnetCommand {
...
impl OnboardNetworkSubnetCommand {
