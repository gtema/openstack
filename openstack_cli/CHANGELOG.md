...
## [0.12.0](https://github.com/gtema/openstack/compare/openstack_cli-v0.11.1...openstack_cli-v0.12.0) - 2025-04-25
...
- Add roundtip test for compute keypairs ([#1176](https://github.com/gtema/openstack/pull/1176))
