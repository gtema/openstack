...
## [0.13.8](https://github.com/gtema/openstack/compare/openstack_cli-v0.13.7...openstack_cli-v0.13.8) - 2026-09-05

### Added

- Add json_pointer_fallback to server list ([#1968](https://github.com/gtema/openstack/pull/1968))
- *(cli)* Add --os-microversion-strategy flag ([#1946](https://github.com/gtema/openstack/pull/1946))
- *(sdk)* Add WASM auth plugin runtime and CLI management ([#1934](https://github.com/gtema/openstack/pull/1934))
...
- *(cli)* Avoid panic when config fails to load ([#1973](https://github.com/gtema/openstack/pull/1973))
- CLI error hints for wait combinator failures ([#1971](https://github.com/gtema/openstack/pull/1971))
...
## [0.13.6](https://github.com/gtema/openstack/compare/openstack_cli-v0.13.5...openstack_cli-v0.13.6) - 2026-05-14
...
- Complete removing `unwrap` and `expect` use ([#1516](https://github.com/gtema/openstack/pull/1516))
- No `unwrap` and `expect` in generated code ([#1511](https://github.com/gtema/openstack/pull/1511))
- Address some `unwrap`s in `openstack_cli` ([#1510](https://github.com/gtema/openstack/pull/1510))
...
- *(ci)* Vendor cirros image under GitHub releases ([#1527](https://github.com/gtema/openstack/pull/1527))
...
- *(deps)* Bump hyper from 1.7.0 to 1.8.1 ([#1518](https://github.com/gtema/openstack/pull/1518))
