...
//! set to true. Note that an issuing a DELETE request simply marks the account
//! for deletion later as outlined in the link:
//! https://docs.openstack.org/swift/latest/overview_reaper.html. Take care
//! when performing this operation because deleting an account is a one-way
//! operation that is not trivially recoverable. It''s crucial to note that in
//! an OpenStack context, you should delete an account after the project/tenant
//! has been deleted from Keystone.
//!
