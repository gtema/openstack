...
//! Creates, updates, or deletes account metadata. To create, update, or delete
//! custom metadata, use the X-Account-Meta-{name} request header, where {name}
//! is the name of the metadata item. Account metadata operations work
//! differently than how object metadata operations work. Depending on the
//! contents of your POST account metadata request, the Object Storage API
//! updates the metadata as shown in the following table: TODO: fill the rest
