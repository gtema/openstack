...
use crate::api::block_storage::v3::group_type::{get as Get, list as List};

/// Find for group_type by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // group_type is not supporting name as query parameter to the list.
