...
use crate::api::block_storage::v3::snapshot::{get as Get, list_detailed as List};

/// Find for snapshot by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // snapshot is not supporting name as query parameter to the list.
