...
use crate::api::block_storage::v3::qos_spec::{get as Get, list as List};

/// Find for qos_spec by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // qos_spec is not supporting name as query parameter to the list.
