...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Volume_Type_Access.
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            ...
            then.status(200)
                ...
                .json_body(json!({ "volume_type_access": {} }));
        });

        let endpoint = Request::builder().type_id("type_id").build().unwrap();
