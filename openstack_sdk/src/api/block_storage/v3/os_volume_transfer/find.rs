...
use crate::api::block_storage::v3::os_volume_transfer::{get as Get, list_detailed as List};

/// Find for os_volume_transfer by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // os_volume_transfer is not supporting name as query parameter to the list.
