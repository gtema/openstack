...
use crate::api::block_storage::v3::group_snapshot::{get as Get, list_detailed as List};

/// Find for group_snapshot by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // group_snapshot is not supporting name as query parameter to the list.
