...
use crate::api::block_storage::v3::backup::{get as Get, list_detailed as List};

/// Find for backup by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // backup is not supporting name as query parameter to the list.
