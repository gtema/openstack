...
use crate::api::identity::v3::user::access_rule::{get as Get, list as List};

/// Find for user/access_rule by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // user/access_rule is not supporting name as query parameter to the list.
