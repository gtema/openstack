...
/// Find for availability_zone_profile by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    /// Locate availability_zone_profile in a list
    fn locate_resource_in_list<C: RestClient>(
        &self,
        data: Vec<serde_json::Value>,
    ) -> Result<serde_json::Value, ApiError<C::Error>> {
        // availability_zone_profile is not supporting name as query parameter to the list.
