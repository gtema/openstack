...
//! Creates a namespace.
//!
//! A namespace must be unique across all users. Attempting to create an
//! already existing namespace will result in a 409 (Conflict) response.
//!
//! The `Location` response header contains the newly-created URI for the
//! namespace.
//!
