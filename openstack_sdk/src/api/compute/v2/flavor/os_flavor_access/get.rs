...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Os_Flavor_Access.
    ...
    fn endpoint() {
        ...
        let mock = client.server.mock(|when, then| {
            ...
            then.status(200)
                ...
                .json_body(json!({ "flavor_access": {} }));
        });

        let endpoint = Request::builder().flavor_id("flavor_id").build().unwrap();
