...
use crate::api::compute::v2::hypervisor::{get as Get, list_detailed as List};

/// Find for hypervisor by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    /// Locate hypervisor in a list
    fn locate_resource_in_list<C: RestClient>(
        &self,
        data: Vec<serde_json::Value>,
    ) -> Result<serde_json::Value, ApiError<C::Error>> {
        // hypervisor is not supporting name as query parameter to the list.
