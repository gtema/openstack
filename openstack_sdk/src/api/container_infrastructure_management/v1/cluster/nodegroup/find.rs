...
use crate::api::container_infrastructure_management::v1::cluster::nodegroup::{
    get as Get, list as List,
};

/// Find for cluster/nodegroup by nameOrId.
...
impl<'a> Findable for Request<'a> {
    ...
    fn locate_resource_in_list<C: RestClient>(
        ...
        // cluster/nodegroup is not supporting name as query parameter to the list.
