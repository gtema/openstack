...
//!
//! A 409 Conflict response code will be returned if there exist allocations
//! records for any of the inventories that would be deleted as a result of
//! removing the resource provider.
//!
...
mod tests {
    ...
    fn endpoint() {
        ...
        let endpoint = Request::builder().uuid("uuid").build().unwrap();
