...
impl RestEndpoint for Request<'_> {
    ...
    fn parameters(&self) -> QueryParams {
        ...
        params.push_opt("event", self.event.as_ref());
        params.push_opt("id", self.id.as_ref());
        params.push_opt("name", self.name.as_ref());
        params.push_opt("project_id", self.project_id.as_ref());
        params.push_opt("resource_id", self.resource_id.as_ref());
        params.push_opt("resource_type", self.resource_type.as_ref());
        params.push_opt("revision_number", self.revision_number.as_ref());
        params.push_opt("target_id", self.target_id.as_ref());
