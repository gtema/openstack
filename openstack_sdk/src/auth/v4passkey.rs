...
pub enum PasskeyError {
    ...
    InitAuthBuilder {
        #[from]
        source: AuthStartRequestBuilderError,
    },
...
impl From<RequestAuthenticationExtensions>
    for webauthn_rs_proto::extensions::RequestAuthenticationExtensions
{
    fn from(val: RequestAuthenticationExtensions) -> Self {
        Self {
            appid: val.appid,
...
impl From<PublicKeyCredentialHint> for webauthn_rs_proto::options::PublicKeyCredentialHints {
    fn from(val: PublicKeyCredentialHints) -> Self {
        match val {
...
impl From<AllowCredentials> for webauthn_rs_proto::options::AllowCredentials {
    fn from(val: AllowCredentials) -> Self {
        Self {
...
{
    fn from(val: PublicKeyCredentialRequestOptions) -> Self {
        Self {
...
impl From<PasskeyAuthenticationStartResponse> for webauthn_rs::prelude::RequestChallengeResponse {
