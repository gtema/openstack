...
//! Delete Trait command [microversion = 1.6]
//!
...
use openstack_sdk::api::placement::v1::r#trait::delete_16;
...
#[derive(Args)]
#[command(about = "Delete traits (microversion = 1.6)")]
...
impl TraitCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("placement.trait"), Some("delete"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = delete_16::Request::builder();
