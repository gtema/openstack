...
//! Show Aggregate command [microversion = 1.1]
//!
...
use openstack_sdk::api::placement::v1::resource_provider::aggregate::list_11;
...
/// list.)
#[derive(Args)]
#[command(about = "List resource provider aggregates (microversion = 1.1)")]
...
impl AggregateCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_11::Request::builder();
