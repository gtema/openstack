...
//! Set Trait command [microversion = 1.6]
//!
...
use openstack_sdk::api::placement::v1::resource_provider::r#trait::set_16;
...
#[derive(Args)]
#[command(about = "Update resource provider traits (microversion = 1.6)")]
...
impl TraitCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = set_16::Request::builder();
