...
//! List Usages command [microversion = 1.9]
//!
...
use openstack_sdk::api::placement::v1::usage::list_19;
...
#[derive(Args)]
#[command(about = "List usages (microversion = 1.9)")]
...
impl UsagesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_19::Request::builder();
