...
//! List ResourceClasses command [microversion = 1.2]
//!
...
use openstack_sdk::api::placement::v1::resource_class::list_12;
...
#[derive(Args)]
#[command(about = "List resource classes (microversion = 1.2)")]
...
impl ResourceClassesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let ep_builder = list_12::Request::builder();
