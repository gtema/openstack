...
//! Show AllocationCandidate command [microversion = 1.10]
//!
...
#[derive(Args)]
#[command(about = "List allocation candidates (microversion = 1.10)")]
...
impl AllocationCandidateCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_110::Request::builder();
