...
//! Get Migration command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::migration::get_21;
...
#[derive(Args)]
#[command(about = "List Migrations (microversion = 2.1)")]
...
impl MigrationCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.migration"), Some("get"));
