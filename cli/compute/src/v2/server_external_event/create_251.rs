...
//! Create ServerExternalEvent command [microversion = 2.51]
//!
...
use openstack_sdk::api::compute::v2::server_external_event::create_251;
...
#[derive(Args)]
#[command(about = "Run Events (microversion = 2.51)")]
...
impl ServerExternalEventCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let events_builder: Vec<create_251::Events> = self
            .events
            .iter()
            .flat_map(|v| serde_json::from_value::<create_251::Events>(v.to_owned()))
            .collect::<Vec<create_251::Events>>();
        ...
        op.output_single::<response::create_251::ServerExternalEventResponse>(data.clone())?;
