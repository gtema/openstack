...
//! Create FloatingIp command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::floating_ip::create_21;
...
///
/// If more than one floating IP address pool is available, use the `pool`
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Create (Allocate) Floating Ip Address (microversion = 2.1)")]
...
impl FloatingIpCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let ep_builder = create_21::Request::builder();
