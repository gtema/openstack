...
//! Delete FloatingIp command [microversion = 2.1]
//!
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Delete (Deallocate) Floating Ip Address (microversion = 2.1)")]
...
impl FloatingIpCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("compute.floating_ip"), Some("delete"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = delete_21::Request::builder();
