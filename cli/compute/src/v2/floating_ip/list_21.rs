...
//! List FloatingIps command [microversion = 2.1]
//!
//! Wraps invoking of the `v2.1/os-floating-ips` with `GET` method
...
use openstack_sdk::api::compute::v2::floating_ip::list_21;
...
#[derive(Args)]
#[command(about = "List Floating Ip Addresses (microversion = 2.1)")]
...
impl FloatingIpsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.floating_ip"), Some("list"));
        ...
        op.output_list::<response::list_21::FloatingIpResponse>(data.clone())?;
