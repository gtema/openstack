...
//! Show FloatingIp command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::floating_ip::get_21;
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Show Floating Ip Address Details (microversion = 2.1)")]
...
impl FloatingIpCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.floating_ip"), Some("show"));
