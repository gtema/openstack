...
//! List Extensions command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::extension::list_21;
use openstack_types::compute::v2::extension::response;
...
#[derive(Args)]
#[command(about = "List Extensions (microversion = 2.1)")]
...
impl ExtensionsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.extension"), Some("list"));
