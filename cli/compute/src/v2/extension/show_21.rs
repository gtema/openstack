...
//! Show Extension command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::extension::get_21;
...
#[derive(Args)]
#[command(about = "Show Extension Details (microversion = 2.1)")]
...
impl ExtensionCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.extension"), Some("show"));
