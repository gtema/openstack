...
//! Get Server command [microversion = 2.1]
//!
//! Wraps invoking of the `v2.1/os-hypervisors/{id}/servers` with `GET` method
...
#[derive(Args)]
#[command(about = "List Hypervisor Servers (DEPRECATED) (microversion = 2.1)")]
...
struct PathParameters {
    /// id parameter for /v2.1/os-hypervisors/{id}/servers API
    #[arg(
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("compute.hypervisor/server"), Some("get"));
