...
//! Get Statistic command [microversion = 2.1]
//!
//! Wraps invoking of the `v2.1/os-hypervisors/statistics` with `GET` method
...
#[derive(Args)]
#[command(about = "Show Hypervisor Statistics (DEPRECATED) (microversion = 2.1)")]
...
impl StatisticCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let ep_builder = get_21::Request::builder();
