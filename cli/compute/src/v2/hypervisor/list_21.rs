...
//! List Hypervisors command [microversion = 2.1]
//!
...
#[derive(Args)]
#[command(about = "List Hypervisors Details (microversion = 2.1)")]
...
impl HypervisorsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.hypervisor"), Some("list"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = list_detailed_21::Request::builder();
