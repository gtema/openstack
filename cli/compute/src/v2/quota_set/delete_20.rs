...
//! Delete QuotaSet command [microversion = 2.0]
//!
...
use openstack_sdk::api::compute::v2::quota_set::delete_20;
...
#[derive(Args)]
#[command(about = "Revert Quotas To Defaults (microversion = 2.0)")]
...
impl QuotaSetCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.quota_set"), Some("delete"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = delete_20::Request::builder();
