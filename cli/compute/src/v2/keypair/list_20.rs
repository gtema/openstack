...
//! List Keypairs command [microversion = 2.0]
//!
...
#[derive(Args)]
#[command(about = "List Keypairs (microversion = 2.0)")]
...
impl KeypairsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.keypair"), Some("list"));
