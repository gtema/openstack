...
//! Show Keypair command [microversion = 2.0]
//!
...
#[derive(Args)]
#[command(about = "Show Keypair Details (microversion = 2.0)")]
...
impl KeypairCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.keypair"), Some("show"));
