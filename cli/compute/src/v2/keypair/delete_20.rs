...
//! Delete Keypair command [microversion = 2.0]
//!
...
use openstack_sdk::api::compute::v2::keypair::delete_20;
...
#[derive(Args)]
#[command(about = "Delete Keypair (microversion = 2.0)")]
...
impl KeypairCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.keypair"), Some("delete"));
