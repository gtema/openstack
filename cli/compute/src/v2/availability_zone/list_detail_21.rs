...
//! List AvailabilityZones command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::availability_zone::list_detail_21;
...
#[derive(Args)]
#[command(about = "Get Detailed Availability Zone Information (microversion = 2.1)")]
...
impl AvailabilityZonesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(
            parsed_args,
            Some("compute.availability_zone"),
            Some("list"),
        );
        op.validate_args(parsed_args)?;

        let ep_builder = list_detail_21::Request::builder();
