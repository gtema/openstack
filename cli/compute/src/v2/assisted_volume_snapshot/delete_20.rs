...
//! Delete AssistedVolumeSnapshot command [microversion = 2.0]
//!
...
use openstack_sdk::api::compute::v2::assisted_volume_snapshot::delete_20;
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Delete Assisted Volume Snapshot (microversion = 2.0)")]
