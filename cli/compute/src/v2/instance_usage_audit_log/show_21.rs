...
//! Show InstanceUsageAuditLog command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::instance_usage_audit_log::get_21;
...
#[derive(Args)]
#[command(about = "List Usage Audits Before Specified Time (microversion = 2.1)")]
...
impl InstanceUsageAuditLogCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        op.output_single::<response::get::InstanceUsageAuditLogResponse>(data.clone())?;
