...
//! List Interfaces command [microversion = 2.1]
//!
...
/// NotImplemented(501)
#[derive(Args)]
#[command(about = "List Port Interfaces (microversion = 2.1)")]
...
impl InterfacesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("compute.server/interface"), Some("list"));
