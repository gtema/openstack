...
//! Get Diagnostic command [microversion = 2.1]
//!
...
#[derive(Args)]
#[command(about = "Show Server Diagnostics (microversion = 2.1)")]
...
impl DiagnosticCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("compute.server/diagnostic"), Some("get"));
