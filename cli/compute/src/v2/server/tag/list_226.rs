...
//! List Tags command [microversion = 2.26]
//!
...
use openstack_sdk::api::compute::v2::server::tag::list_226;
use openstack_types::compute::v2::server::tag::response;
...
#[derive(Args)]
#[command(about = "List Tags (microversion = 2.26)")]
...
impl TagsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.server/tag"), Some("list"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = list_226::Request::builder();
        ...
        op.output_list::<response::list_226::TagResponse>(data.clone())?;
