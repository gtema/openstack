...
//!
//! Wraps invoking of the `v2.1/servers/{server_id}/tags/{id}` with `DELETE` method
...
use openstack_sdk::api::compute::v2::server::tag::delete_226;
...
#[derive(Args)]
#[command(about = "Delete a Single Tag (microversion = 2.26)")]
...
impl TagCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_226::Request::builder();
