...
//! Delete Tag command [microversion = 2.26]
//!
//! Wraps invoking of the `v2.1/servers/{server_id}/tags` with `DELETE` method
...
use openstack_sdk::api::compute::v2::server::tag::delete_all_226;
...
#[derive(Args)]
#[command(about = "Delete All Tags (microversion = 2.26)")]
...
impl TagCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_all_226::Request::builder();
