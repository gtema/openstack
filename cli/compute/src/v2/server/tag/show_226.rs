...
//! Show Tag command [microversion = 2.26]
//!
//! Wraps invoking of the `v2.1/servers/{server_id}/tags/{id}` with `GET` method
...
use openstack_sdk::api::compute::v2::server::tag::get_226;
...
#[derive(Args)]
#[command(about = "Check Tag Existence (microversion = 2.26)")]
...
impl TagCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.server/tag"), Some("show"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = get_226::Request::builder();
