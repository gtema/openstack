...
use openstack_sdk::api::compute::v2::server::add_floating_ip;
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Add (Associate) Floating Ip (addFloatingIp Action) (DEPRECATED)")]
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = add_floating_ip::Request::builder();
        ...
        let mut add_floating_ip_builder = add_floating_ip::AddFloatingIpBuilder::default();
        ...
        ep_builder.add_floating_ip(
            add_floating_ip_builder
                .build()
