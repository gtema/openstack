...
//! List Migrations command [microversion = 2.23]
//!
...
#[derive(Args)]
#[command(about = "List Migrations (microversion = 2.23)")]
...
impl MigrationsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("compute.server/migration"), Some("list"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = list_223::Request::builder();
