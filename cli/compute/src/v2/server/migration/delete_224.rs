...
//! Delete Migration command [microversion = 2.24]
//!
...
use openstack_sdk::api::compute::v2::server::migration::delete_224;
...
#[derive(Args)]
#[command(about = "Delete (Abort) Migration (microversion = 2.24)")]
...
impl MigrationCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_224::Request::builder();
