...
use openstack_sdk::api::compute::v2::server::migration::force_complete;
...
#[derive(Args)]
#[command(about = "Force Migration Complete Action (force_complete Action)")]
...
impl MigrationCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = force_complete::Request::builder();
