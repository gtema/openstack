...
//! List SecurityGroups command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::server::security_group::list_21;
...
#[derive(Args)]
#[command(about = "List Security Groups By Server (microversion = 2.1)")]
