...
//! List Metadatas command [microversion = 2.1]
//!
//! Wraps invoking of the `v2.1/servers/{server_id}/metadata` with `GET` method
...
use openstack_sdk::api::compute::v2::server::metadata::list_21;
...
#[derive(Args)]
#[command(about = "List All Metadata (microversion = 2.1)")]
...
impl MetadatasCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("compute.server/metadata"), Some("list"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = list_21::Request::builder();
