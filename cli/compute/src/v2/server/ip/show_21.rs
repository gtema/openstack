...
//! Show Ip command [microversion = 2.1]
//!
...
#[derive(Args)]
#[command(about = "Show Ip Details (microversion = 2.1)")]
...
impl IpCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.server/ip"), Some("show"));
