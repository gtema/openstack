...
//! Create Server command [microversion = 2.52]
//!
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        if let Some(val) = &args.block_device_mapping {
            let block_device_mapping_builder: Vec<create_252::BlockDeviceMapping> = val
                .iter()
                .flat_map(|v| {
                    serde_json::from_value::<create_252::BlockDeviceMapping>(v.to_owned())
                })
        ...
        if let Some(val) = &args.block_device_mapping_v2 {
            let block_device_mapping_v2_builder: Vec<create_252::BlockDeviceMappingV2> = val
                .iter()
                .flat_map(|v| {
                    serde_json::from_value::<create_252::BlockDeviceMappingV2>(v.to_owned())
                })
        ...
        if let Some(val) = &args.personality {
            let personality_builder: Vec<create_252::Personality> = val
                .iter()
                .flat_map(|v| serde_json::from_value::<create_252::Personality>(v.to_owned()))
