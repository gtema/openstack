...
//! List Shares command [microversion = 2.97]
//!
...
use openstack_sdk::api::compute::v2::server::share::list_297;
...
#[derive(Args)]
#[command(about = "List share attachments for an instance (microversion = 2.97)")]
...
impl SharesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_297::Request::builder();
