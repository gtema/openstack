...
#[derive(Args)]
#[command(about = "Get SPICE Console (os-getSPICEConsole Action) (DEPRECATED)")]
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut os_get_spiceconsole_builder =
            os_get_spiceconsole::OsGetSpiceconsoleBuilder::default();

        let tmp = match &args._type {
            Type::SpiceHtml5 => os_get_spiceconsole::Type::SpiceHtml5,
        };
        os_get_spiceconsole_builder._type(tmp);

        ep_builder.os_get_spiceconsole(
            os_get_spiceconsole_builder
                .build()
        ...
        op.output_single::<response::os_get_spiceconsole::ServerResponse>(data.clone())?;
