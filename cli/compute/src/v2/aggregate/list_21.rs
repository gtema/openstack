...
//! List Aggregates command [microversion = 2.1]
//!
...
#[derive(Args)]
#[command(about = "List Aggregates (microversion = 2.1)")]
...
impl AggregatesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.aggregate"), Some("list"));
