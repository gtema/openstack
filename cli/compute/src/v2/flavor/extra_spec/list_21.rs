...
//! List ExtraSpecs command [microversion = 2.1]
//!
//! Wraps invoking of the `v2.1/flavors/{flavor_id}/os-extra_specs` with `GET` method
...
use openstack_sdk::api::compute::v2::flavor::extra_spec::list_21;
...
#[derive(Args)]
#[command(about = "List Extra Specs For A Flavor (microversion = 2.1)")]
