...
//! List FlavorAccesses command [microversion = 2.1]
//!
...
use openstack_sdk::api::compute::v2::flavor::flavor_access::list_21;
...
#[derive(Args)]
#[command(about = "List Flavor Access Information For Given Flavor (microversion = 2.1)")]
