...
//! Create Flavor command [microversion = 2.102]
//!
...
use openstack_sdk::api::compute::v2::flavor::create_2102;
...
/// conflict(409)
#[derive(Args)]
#[command(about = "Create Flavor (microversion = 2.102)")]
...
impl FlavorCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = create_2102::Request::builder();
        ep_builder.header(
            http::header::HeaderName::from_static("openstack-api-version"),
            http::header::HeaderValue::from_static("compute 2.102"),
        );

        // Set body parameters
        // Set Request.flavor data
        let args = &self.flavor;
        let mut flavor_builder = create_2102::FlavorBuilder::default();
        ...
        op.output_single::<response::create_2102::FlavorResponse>(data.clone())?;
