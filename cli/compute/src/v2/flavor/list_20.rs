...
//! List Flavors command [microversion = 2.0]
//!
...
#[derive(Args)]
#[command(about = "List Flavors With Details (microversion = 2.0)")]
...
impl FlavorsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("compute.flavor"), Some("list"));
