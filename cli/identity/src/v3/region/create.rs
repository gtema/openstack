...
use openstack_types::identity::v3::region::response;
...
impl RegionCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("identity.region"), Some("create"));
        ...
        op.output_single::<response::create::RegionResponse>(data.clone())?;
