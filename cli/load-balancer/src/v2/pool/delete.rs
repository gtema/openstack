...
//! Delete Pool command
//!
//! Wraps invoking of the `v2/lbaas/pools/{pool_id}` with `DELETE` method
...
use openstack_sdk::api::load_balancer::v2::pool::delete;
use openstack_sdk::api::load_balancer::v2::pool::get;
...
impl PoolCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("load-balancer.pool"), Some("delete"));
