...
//! List GroupSnapshots command [microversion = 3.14]
//!
//! Wraps invoking of the `v3/group_snapshots/detail` with `GET` method
...
impl GroupSnapshotsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_detailed_314::Request::builder();
