...
//! Show DefaultType command [microversion = 3.62]
//!
//! Wraps invoking of the `v3/default-types/{id}` with `GET` method
...
use openstack_sdk::api::block_storage::v3::default_type::get_362;
...
impl DefaultTypeCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = get_362::Request::builder();
        ...
        op.output_single::<response::get::DefaultTypeResponse>(data.clone())?;
