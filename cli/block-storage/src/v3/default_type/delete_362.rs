...
//! Delete DefaultType command [microversion = 3.62]
//!
//! Wraps invoking of the `v3/default-types/{id}` with `DELETE` method
...
use openstack_sdk::api::block_storage::v3::default_type::delete_362;
...
impl DefaultTypeCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_362::Request::builder();
