...
impl QuotaSetCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("block-storage.quota_set"), Some("set"));
        ...
        ep_builder.quota_set(self.quota_set.iter().cloned());
        ...
        op.output_single::<response::set::QuotaSetResponse>(data.clone())?;
