...
//!
//! Wraps invoking of the `v3/os-quota-sets/{project_id}` with `GET` method
...
use openstack_sdk::api::block_storage::v3::quota_set::get;
use openstack_sdk::api::find_by_name;
use openstack_sdk::api::identity::v3::project::find as find_project;
use openstack_types::block_storage::v3::quota_set::response;
use tracing::warn;

/// Show quota for a particular tenant
#[derive(Args)]
#[command(about = "Show quota for a particular tenant")]
...
impl QuotaSetCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        if let Some(val) = &self.query.usage {
            ep_builder.usage(*val);
        }
        ...
        op.output_single::<response::get::QuotaSetResponse>(data.clone())?;
