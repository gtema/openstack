...
//!
//! Wraps invoking of the `v3/snapshots/{id}` with `DELETE` method
...
use openstack_sdk::api::block_storage::v3::snapshot::delete;
use openstack_sdk::api::block_storage::v3::snapshot::get;
...
impl SnapshotCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("block-storage.snapshot"), Some("delete"));
