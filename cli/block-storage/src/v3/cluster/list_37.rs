...
//! List Clusters command [microversion = 3.7]
//!
...
use openstack_sdk::api::block_storage::v3::cluster::list_detailed_37;
...
impl ClustersCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_detailed_37::Request::builder();
        ...
        op.output_list::<response::list_detailed::ClusterResponse>(data.clone())?;
