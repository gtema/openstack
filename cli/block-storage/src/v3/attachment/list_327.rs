...
//! List Attachments command [microversion = 3.27]
//!
...
use openstack_sdk::api::block_storage::v3::attachment::list_detailed_327;
...
impl AttachmentsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_detailed_327::Request::builder();
