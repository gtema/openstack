...
//! Delete Attachment command [microversion = 3.27]
//!
...
///
/// Disconnects/Deletes the specified attachment, returns a list of any known
...
impl AttachmentCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_327::Request::builder();
