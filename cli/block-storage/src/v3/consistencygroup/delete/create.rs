...
//!
//! Wraps invoking of the `v3/consistencygroups/{id}/delete` with `POST` method
...
use openstack_types::block_storage::v3::consistencygroup::delete::response;
...
impl DeleteCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(
            parsed_args,
            Some("block-storage.consistencygroup/delete"),
            Some("create"),
        );
        ...
        op.output_single::<response::create::DeleteResponse>(data.clone())?;
