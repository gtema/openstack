...
//! List ResourceFilters command [microversion = 3.33]
//!
...
use openstack_sdk::api::block_storage::v3::resource_filter::list_333;
use openstack_types::block_storage::v3::resource_filter::response;
...
impl ResourceFiltersCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let ep_builder = list_333::Request::builder();
        ...
        op.output_list::<response::list::ResourceFilterResponse>(data.clone())?;
