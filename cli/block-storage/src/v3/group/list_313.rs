...
//! List Groups command [microversion = 3.13]
//!
...
use openstack_sdk::api::block_storage::v3::group::list_detailed_313;
...
impl GroupsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("block-storage.group"), Some("list"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = list_detailed_313::Request::builder();
