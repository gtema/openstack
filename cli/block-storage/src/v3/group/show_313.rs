...
//! Show Group command [microversion = 3.13]
//!
...
impl GroupCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("block-storage.group"), Some("show"));
        ...
        op.output_single::<response::get::GroupResponse>(find_data.clone())?;
