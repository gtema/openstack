...
//! List GroupTypes command [microversion = 3.11]
//!
...
use openstack_sdk::api::block_storage::v3::group_type::list_311;
...
impl GroupTypesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("block-storage.group_type"), Some("list"));
