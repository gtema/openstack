...
//! Delete GroupType command [microversion = 3.11]
//!
//! Wraps invoking of the `v3/group_types/{id}` with `DELETE` method
...
use openstack_sdk::api::block_storage::v3::group_type::delete_311;
...
impl GroupTypeCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_311::Request::builder();
