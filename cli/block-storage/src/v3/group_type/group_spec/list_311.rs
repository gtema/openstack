...
//! List GroupSpecs command [microversion = 3.11]
//!
...
use openstack_sdk::api::block_storage::v3::group_type::group_spec::list_311;
...
impl GroupSpecsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_311::Request::builder();
