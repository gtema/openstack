...
//! Delete VolumeTransfer command [microversion = 3.55]
//!
//! Wraps invoking of the `v3/volume-transfers/{id}` with `DELETE` method
...
use openstack_sdk::api::block_storage::v3::volume_transfer::delete_355;
...
impl VolumeTransferCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = delete_355::Request::builder();
