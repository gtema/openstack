...
//! List VolumeTransfers command [microversion = 3.55]
//!
...
use openstack_sdk::api::block_storage::v3::volume_transfer::list_detailed_355;
...
impl VolumeTransfersCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = list_detailed_355::Request::builder();
