...
//! List Messages command [microversion = 3.3]
//!
...
use openstack_sdk::api::block_storage::v3::message::list_33;
...
impl MessagesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("block-storage.message"), Some("list"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = list_33::Request::builder();
