...
//! Show Message command [microversion = 3.3]
//!
...
use openstack_sdk::api::block_storage::v3::message::get_33;
...
impl MessageCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op =
            OutputProcessor::from_args(parsed_args, Some("block-storage.message"), Some("show"));
        op.validate_args(parsed_args)?;

        let mut ep_builder = get_33::Request::builder();
        ...
        op.output_single::<response::get::MessageResponse>(data.clone())?;
