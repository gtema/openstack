...
//! Set MinimumPacketRateRule command
//!
//! Wraps invoking of the `v2.0/qos/policies/{policy_id}/minimum-packet-rate-rules/{id}` with `PUT` method
...
use openstack_types::network::v2::qos::policy::minimum_packet_rate_rule::response;
...
impl MinimumPacketRateRuleCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        op.output_single::<response::set::MinimumPacketRateRuleResponse>(data.clone())?;
