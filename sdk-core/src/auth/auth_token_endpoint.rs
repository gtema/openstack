...
//!
//! This is mostly a copy of the identity/auth/token/create endpoint which is necessary to
//! guarantee certain code stability once the autogenerated endpoint code changes.
use derive_builder::Builder;
use http::{HeaderMap, HeaderName, HeaderValue};
use openstack_sdk_auth_core::AuthTokenError;
...
/// A `user` object for the password authentication.
#[derive(Builder, Debug, Deserialize, Clone, Serialize)]
#[builder(build_fn(error = "BuilderError"))]
#[builder(setter(strip_option))]
...
impl From<BuilderError> for AuthTokenError {
    fn from(value: BuilderError) -> Self {
        AuthTokenError::auth_request(value)
    }
}
