...
pub struct PoolResponse {
    /// The capabilities for the back end. The value is either `null` or a
    /// string value that indicates the capabilities for each pool. For
    /// example, `total_capacity_gb` or `QoS_support`.
    #[serde(default)]
