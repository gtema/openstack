...
//! Response type for the GET `os-volume-manage/detail` operation
...
pub struct VolumeManageResponse(BTreeMap<String, Value>);

impl StructTable for VolumeManageResponse {
