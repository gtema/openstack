...
//! Response type for the GET `os-snapshot-manage/detail` operation
...
pub struct SnapshotManageResponse(BTreeMap<String, Value>);

impl StructTable for SnapshotManageResponse {
