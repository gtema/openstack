...
//! Response type for the PUT `consistencygroups/{id}/update` operation
...
pub struct ConsistencygroupResponse(BTreeMap<String, Value>);

impl StructTable for ConsistencygroupResponse {
