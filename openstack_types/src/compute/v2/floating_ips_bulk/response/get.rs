...
//! Response type for the GET `os-floating-ips-bulk/{id}` operation
...
pub struct FloatingIpsBulkResponse(BTreeMap<String, Value>);

impl StructTable for FloatingIpsBulkResponse {
