...
//! Response type for the PUT `octavia/amphorae/{amphora_id}/failover` operation
...
pub struct AmphoraeResponse(BTreeMap<String, Value>);

impl StructTable for AmphoraeResponse {
