...
//! Response type for the PUT `lbaas/loadbalancers/{loadbalancer_id}/failover` operation
...
pub struct LoadbalancerResponse(BTreeMap<String, Value>);

impl StructTable for LoadbalancerResponse {
