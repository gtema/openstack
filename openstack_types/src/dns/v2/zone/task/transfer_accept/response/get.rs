...
//! Response type for the GET `zones/tasks/transfer_accepts/{transfer_accept_id}` operation
...
pub struct TransferAcceptResponse(BTreeMap<String, Value>);

impl StructTable for TransferAcceptResponse {
