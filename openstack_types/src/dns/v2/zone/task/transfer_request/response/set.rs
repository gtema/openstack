...
//! Response type for the PATCH `zones/tasks/transfer_requests/{zone_transfer_request_id}` operation
...
pub struct TransferRequestResponse(BTreeMap<String, Value>);

impl StructTable for TransferRequestResponse {
