...
//! Response type for the PUT `agents/{agent_id}/dhcp-networks/{id}` operation
...
pub struct DhcpNetworkResponse(BTreeMap<String, Value>);

impl StructTable for DhcpNetworkResponse {
