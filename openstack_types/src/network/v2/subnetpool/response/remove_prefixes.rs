...
//! Response type for the PUT `subnetpools/{id}/remove_prefixes` operation
...
pub struct SubnetpoolResponse(BTreeMap<String, Value>);

impl StructTable for SubnetpoolResponse {
