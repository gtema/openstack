...
//! Response type for the PUT `subnetpools/{id}/onboard_network_subnets` operation
...
pub struct OnboardNetworkSubnetResponse(BTreeMap<String, Value>);

impl StructTable for OnboardNetworkSubnetResponse {
