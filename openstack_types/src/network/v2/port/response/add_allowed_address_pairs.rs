...
//! Response type for the PUT `ports/{port_id}/add_allowed_address_pairs` operation
...
pub struct PortResponse(BTreeMap<String, Value>);

impl StructTable for PortResponse {
