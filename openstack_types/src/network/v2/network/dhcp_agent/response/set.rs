...
//! Response type for the PUT `networks/{network_id}/dhcp-agents/{id}` operation
...
pub struct DhcpAgentResponse(BTreeMap<String, Value>);

impl StructTable for DhcpAgentResponse {
