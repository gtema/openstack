...
//! Response type for the POST `images/{image_id}/actions/deactivate` operation
...
pub struct ImageResponse(BTreeMap<String, Value>);

impl StructTable for ImageResponse {
