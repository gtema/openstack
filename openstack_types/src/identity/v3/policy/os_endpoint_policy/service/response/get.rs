...
//! Response type for the GET `policies/{policy_id}/OS-ENDPOINT-POLICY/services/{service_id}` operation
...
pub struct ServiceResponse(BTreeMap<String, Value>);

impl StructTable for ServiceResponse {
