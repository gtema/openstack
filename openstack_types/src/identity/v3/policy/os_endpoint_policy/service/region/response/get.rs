...
//! Response type for the GET `policies/{policy_id}/OS-ENDPOINT-POLICY/services/{service_id}/regions/{region_id}` operation
...
pub struct RegionResponse(BTreeMap<String, Value>);

impl StructTable for RegionResponse {
