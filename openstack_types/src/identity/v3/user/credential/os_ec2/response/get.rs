...
//! Response type for the GET `users/{user_id}/credentials/OS-EC2/{credential_id}` operation
...
pub struct OsEc2Response(BTreeMap<String, Value>);

impl StructTable for OsEc2Response {
