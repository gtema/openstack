...
//! Response type for the PUT `OS-OAUTH1/authorize/{request_token_id}` operation
...
pub struct AuthorizeResponse(BTreeMap<String, Value>);

impl StructTable for AuthorizeResponse {
