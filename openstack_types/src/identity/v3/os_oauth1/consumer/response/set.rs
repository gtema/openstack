...
//! Response type for the PATCH `OS-OAUTH1/consumers/{consumer_id}` operation
...
pub struct ConsumerResponse(BTreeMap<String, Value>);

impl StructTable for ConsumerResponse {
