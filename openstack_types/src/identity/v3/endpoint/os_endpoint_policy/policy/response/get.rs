...
//! Response type for the GET `endpoints/{endpoint_id}/OS-ENDPOINT-POLICY/policy` operation
...
pub struct PolicyResponse(BTreeMap<String, Value>);

impl StructTable for PolicyResponse {
