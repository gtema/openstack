...
//! Response type for the GET `OS-EP-FILTER/endpoint_groups/{endpoint_group_id}/projects/{project_id}` operation
...
pub struct ProjectResponse(BTreeMap<String, Value>);

impl StructTable for ProjectResponse {
