...
//! Response type for the PATCH `domains/{domain_id}/config/{group}/{option}` operation
...
pub struct OptionResponse(BTreeMap<String, Value>);

impl StructTable for OptionResponse {
