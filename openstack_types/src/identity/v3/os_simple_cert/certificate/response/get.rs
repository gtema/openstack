...
//! Response type for the GET `OS-SIMPLE-CERT/certificates` operation
...
pub struct CertificateResponse(BTreeMap<String, Value>);

impl StructTable for CertificateResponse {
