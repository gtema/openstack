...
pub struct NetworkNetworkDelete {
    pub id: String,
    #[builder(default)]
    pub name: Option<String>,
}

impl fmt::Display for NetworkNetworkDelete {
...
impl TryFrom<&NetworkNetworkDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &NetworkNetworkDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for NetworkNetworkDelete {
...
impl ConfirmableRequest for NetworkNetworkDelete {
