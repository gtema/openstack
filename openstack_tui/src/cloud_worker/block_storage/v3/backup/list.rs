...
use openstack_sdk::api::block_storage::v3::backup::list::RequestBuilder;
...
impl From<&BlockStorageBackupList> for RequestBuilder<'_> {
    fn from(value: &BlockStorageBackupList) -> Self {
