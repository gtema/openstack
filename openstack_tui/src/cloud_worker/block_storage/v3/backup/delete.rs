...
impl TryFrom<&BlockStorageBackupDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &BlockStorageBackupDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for BlockStorageBackupDelete {
...
impl ConfirmableRequest for BlockStorageBackupDelete {
    fn get_confirm_message(&self) -> Option<String> {
        Some(format!(
            "Delete BlockStorage Backup {} ?",
            self.name.clone().unwrap_or(self.id.clone())
        ))
    }
}
