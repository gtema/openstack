...
pub struct BlockStorageSnapshotDelete {
    pub id: String,
    #[builder(default)]
...
impl TryFrom<&BlockStorageSnapshotDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &BlockStorageSnapshotDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for BlockStorageSnapshotDelete {
...
impl ConfirmableRequest for BlockStorageSnapshotDelete {
    fn get_confirm_message(&self) -> Option<String> {
        Some(format!(
            "Delete BlockStorage Snapshot {} ?",
            self.name.clone().unwrap_or(self.id.clone())
        ))
    }
}
