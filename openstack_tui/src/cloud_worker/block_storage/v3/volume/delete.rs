...
impl From<&BlockStorageVolumeDelete> for RequestBuilder<'_> {
    fn from(value: &BlockStorageVolumeDelete) -> Self {
...
impl ExecuteApiRequest for BlockStorageVolumeDelete {
