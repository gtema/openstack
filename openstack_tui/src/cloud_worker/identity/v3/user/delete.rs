...
impl TryFrom<&IdentityUserDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &IdentityUserDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for IdentityUserDelete {
...
impl ConfirmableRequest for IdentityUserDelete {
