...
pub struct IdentityGroupDelete {
    pub id: String,
    #[builder(default)]
...
impl TryFrom<&IdentityGroupDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &IdentityGroupDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for IdentityGroupDelete {
...
impl ConfirmableRequest for IdentityGroupDelete {
