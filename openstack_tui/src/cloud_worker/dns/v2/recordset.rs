...
//! `/v2/recordsets` REST operations bindings of Dns
...
impl ConfirmableRequest for DnsRecordsetApiRequest {
...
impl ExecuteApiRequest for DnsRecordsetApiRequest {
    async fn execute_request(
        ...
        match self {
            DnsRecordsetApiRequest::List(req) => {
