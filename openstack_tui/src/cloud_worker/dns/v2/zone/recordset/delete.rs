...
pub struct DnsZoneRecordsetDelete {
    pub id: String,
    #[builder(default)]
...
impl TryFrom<&DnsZoneRecordsetDelete> for RequestBuilder<'_> {
    type Error = Report;
...
impl ExecuteApiRequest for DnsZoneRecordsetDelete {
...
impl ConfirmableRequest for DnsZoneRecordsetDelete {
