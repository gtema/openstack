...
use openstack_sdk::api::compute::v2::flavor::get_20::RequestBuilder;
...
impl TryFrom<&ComputeFlavorShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &ComputeFlavorShow) -> Result<Self, Self::Error> {
