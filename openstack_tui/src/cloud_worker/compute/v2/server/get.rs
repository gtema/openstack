...
use openstack_sdk::api::compute::v2::server::get_20::RequestBuilder;
use openstack_sdk::{AsyncOpenStack, api::QueryAsync};

#[derive(Builder, Clone, Debug, Default, Deserialize, PartialEq, Eq, Serialize)]
#[builder(setter(strip_option))]
pub struct ComputeServerShow {
    pub id: String,
    #[builder(default)]
...
impl TryFrom<&ComputeServerShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &ComputeServerShow) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for ComputeServerShow {
