...
use openstack_sdk::api::compute::v2::server::list::RequestBuilder;
...
impl From<&ComputeServerList> for RequestBuilder<'_> {
    fn from(value: &ComputeServerList) -> Self {
