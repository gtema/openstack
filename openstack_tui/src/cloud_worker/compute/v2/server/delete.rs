...
impl From<&ComputeServerDelete> for RequestBuilder<'_> {
    fn from(value: &ComputeServerDelete) -> Self {
...
impl ExecuteApiRequest for ComputeServerDelete {
