...
use openstack_sdk::api::compute::v2::hypervisor::list::RequestBuilder;
...
impl From<&ComputeHypervisorList> for RequestBuilder<'_> {
    fn from(value: &ComputeHypervisorList) -> Self {
