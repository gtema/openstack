...
//! `/v2.1/os-hypervisors/detail` REST operations bindings of Compute
...
pub enum ComputeHypervisorApiRequest {
    /// Get
    Get(Box<ComputeHypervisorShow>),
    /// ListDetailed
    ListDetailed(Box<ComputeHypervisorList>),
}
...
impl From<ComputeHypervisorList> for ComputeHypervisorApiRequest {
    fn from(item: ComputeHypervisorList) -> Self {
        ComputeHypervisorApiRequest::ListDetailed(Box::new(item))
    }
}

impl From<ComputeHypervisorList> for ComputeApiRequest {
    fn from(item: ComputeHypervisorList) -> Self {
        ComputeApiRequest::Hypervisor(Box::new(ComputeHypervisorApiRequest::from(item)))
    }
}

impl ConfirmableRequest for ComputeHypervisorApiRequest {
