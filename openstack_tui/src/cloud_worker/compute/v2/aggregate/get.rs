...
use openstack_sdk::api::compute::v2::aggregate::get_21::RequestBuilder;
...
impl TryFrom<&ComputeAggregateShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &ComputeAggregateShow) -> Result<Self, Self::Error> {
