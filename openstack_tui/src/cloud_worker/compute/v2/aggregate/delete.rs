...
impl TryFrom<&ComputeAggregateDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &ComputeAggregateDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for ComputeAggregateDelete {
...
impl ConfirmableRequest for ComputeAggregateDelete {
    fn get_confirm_message(&self) -> Option<String> {
        Some(format!(
            "Delete Compute Aggregate {} ?",
            self.name.clone().unwrap_or(self.id.clone())
        ))
    }
}
