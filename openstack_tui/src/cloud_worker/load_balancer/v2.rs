...
impl ConfirmableRequest for LoadBalancerApiRequest {
    fn get_confirm_message(&self) -> Option<String> {
        match &self {
            LoadBalancerApiRequest::Healthmonitor(req) => req.get_confirm_message(),

            LoadBalancerApiRequest::Listener(req) => req.get_confirm_message(),

            LoadBalancerApiRequest::Loadbalancer(req) => req.get_confirm_message(),

            LoadBalancerApiRequest::Pool(req) => req.get_confirm_message(),

            LoadBalancerApiRequest::Quota(req) => req.get_confirm_message(),
        }
    }
}
