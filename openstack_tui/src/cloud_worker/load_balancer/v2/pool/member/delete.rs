...
pub struct LoadBalancerMemberDelete {
    id: String,
    name: Option<String>,
    pool_id: String,
...
impl fmt::Display for LoadBalancerMemberDelete {
...
impl From<&LoadBalancerMemberDelete> for RequestBuilder<'_> {
    fn from(value: &LoadBalancerMemberDelete) -> Self {
...
impl ExecuteApiRequest for LoadBalancerMemberDelete {
...
impl ConfirmableRequest for LoadBalancerMemberDelete {
