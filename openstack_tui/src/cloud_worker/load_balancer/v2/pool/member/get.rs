...
pub struct LoadBalancerPoolMemberShow {
    pub id: String,
    #[builder(default)]
...
impl fmt::Display for LoadBalancerPoolMemberShow {
...
impl TryFrom<&LoadBalancerPoolMemberShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &LoadBalancerPoolMemberShow) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for LoadBalancerPoolMemberShow {
