...
pub struct LoadBalancerMemberShow {
    id: String,
    name: Option<String>,
    pool_id: String,
...
impl fmt::Display for LoadBalancerMemberShow {
...
impl From<&LoadBalancerMemberShow> for RequestBuilder<'_> {
    fn from(value: &LoadBalancerMemberShow) -> Self {
...
impl ExecuteApiRequest for LoadBalancerMemberShow {
