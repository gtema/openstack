...
pub struct LoadBalancerPoolDelete {
    pub id: String,
    #[builder(default)]
    pub name: Option<String>,
}

impl fmt::Display for LoadBalancerPoolDelete {
...
impl TryFrom<&LoadBalancerPoolDelete> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &LoadBalancerPoolDelete) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for LoadBalancerPoolDelete {
...
impl ConfirmableRequest for LoadBalancerPoolDelete {
