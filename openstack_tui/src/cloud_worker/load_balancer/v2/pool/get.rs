...
pub struct LoadBalancerPoolShow {
    pub id: String,
    #[builder(default)]
    pub name: Option<String>,
}

impl fmt::Display for LoadBalancerPoolShow {
...
impl TryFrom<&LoadBalancerPoolShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &LoadBalancerPoolShow) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for LoadBalancerPoolShow {
