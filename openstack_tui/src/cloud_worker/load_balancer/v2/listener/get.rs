...
pub struct LoadBalancerListenerShow {
    pub id: String,
    #[builder(default)]
    pub name: Option<String>,
}

impl fmt::Display for LoadBalancerListenerShow {
...
impl TryFrom<&LoadBalancerListenerShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &LoadBalancerListenerShow) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for LoadBalancerListenerShow {
