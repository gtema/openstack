...
pub struct LoadBalancerQuotaShow {
    pub project_id: String,
    #[builder(default)]
    pub project_name: Option<String>,
}

impl fmt::Display for LoadBalancerQuotaShow {
...
impl TryFrom<&LoadBalancerQuotaShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &LoadBalancerQuotaShow) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for LoadBalancerQuotaShow {
