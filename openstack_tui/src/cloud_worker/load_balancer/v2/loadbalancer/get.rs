...
pub struct LoadBalancerLoadbalancerShow {
    pub id: String,
    #[builder(default)]
    pub name: Option<String>,
}

impl fmt::Display for LoadBalancerLoadbalancerShow {
...
impl TryFrom<&LoadBalancerLoadbalancerShow> for RequestBuilder<'_> {
    type Error = Report;
    fn try_from(value: &LoadBalancerLoadbalancerShow) -> Result<Self, Self::Error> {
...
impl ExecuteApiRequest for LoadBalancerLoadbalancerShow {
