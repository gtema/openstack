...
## [0.13.9](https://github.com/gtema/openstack/compare/openstack_tui-v0.13.8...openstack_tui-v0.13.9) - 2026-09-11

### Fixed

- Handle missing service version ([#1987](https://github.com/gtema/openstack/pull/1987))

## [0.13.8](https://github.com/gtema/openstack/compare/openstack_tui-v0.13.7...openstack_tui-v0.13.8) - 2026-09-07

### Added

- *(rust-tui)* Enable ResourceBehaviour for next services ([#1975](https://github.com/gtema/openstack/pull/1975))
- *(tui)* Wire SG create/update/delete via editor ([#1939](https://github.com/gtema/openstack/pull/1939))
...
- *(tui)* Implement editor_template for sgr create ([#1931](https://github.com/gtema/openstack/pull/1931))
...
- *(tui)* Retry external-editor loop on bad YAML ([#1930](https://github.com/gtema/openstack/pull/1930))
...
- *(tui)* Forward block_storage to gen ResourceBehaviour ([#1977](https://github.com/gtema/openstack/pull/1977))
- *(tui)* Forward identity to gen ResourceBehaviour ([#1976](https://github.com/gtema/openstack/pull/1976))
- *(tui)* Forward load_balancer to gen ResourceBehaviour ([#1978](https://github.com/gtema/openstack/pull/1978))
...
## [0.13.6](https://github.com/gtema/openstack/compare/openstack_tui-v0.13.5...openstack_tui-v0.13.6) - 2026-05-14
...
- Upgrade ratatui version ([#1609](https://github.com/gtema/openstack/pull/1609))
