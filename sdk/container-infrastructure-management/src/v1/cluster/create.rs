...
pub const BODY_SCHEMA: &str = "{\"description\": \"API representation of a cluster.\\n\\nThis class enforces type checking and value constraints, and converts\\nbetween the internal object model and the API representation of a Cluster.\", \"properties\": {\"api_address\": {\"type\": \"string\"}, \"cluster_id\": {\"type\": \"string\"}, \"cluster_template_id\": {\"description\": \"The UUID of the cluster template.\", \"type\": \"string\"}, \"coe_version\": {\"type\": \"string\"}, \"container_version\": {\"type\": \"string\"}, \"create_timeout\": {\"description\": \"The timeout for cluster creation in minutes. The value expected is a\\npositive integer and the default is 60 minutes. If the timeout is reached\\nduring cluster creation process, the operation will be aborted and the\\ncluster status will be set to `CREATE_FAILED`.\", \"type\": \"integer\"}, \"created_at\": {\"format\": \"date-time\", \"type\": \"string\"}, \"discovery_url\": {\"description\": \"The custom discovery url for node discovery. This is used by the COE to\\ndiscover the servers that have been created to host the containers. The\\nactual discovery mechanism varies with the COE. In some cases, Magnum fills\\nin the server info in the discovery service. In other cases, if the\\n`discovery_url` is not specified, Magnum will use the public discovery\\nservice at:\\n\\n```\\nhttps://discovery.etcd.io\\n```\\n\\nIn this case, Magnum will generate a unique url here for each uster and\\nstore the info for the servers.\", \"type\": \"string\"}, \"docker_volume_size\": {\"minimum\": 1, \"type\": \"integer\"}, \"faults\": {\"additionalProperties\": {\"type\": \"string\"}, \"type\": \"object\"}, \"fixed_network\": {\"description\": \"The name or network ID of a Neutron network to provide connectivity to\\nthe internal network for the cluster.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"fixed_subnet\": {\"description\": \"Fixed subnet that are using to allocate network address for nodes in\\ncluster.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"flavor_id\": {\"description\": \"The nova flavor ID or name for booting the node servers. The default is\\n`m1.small`.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"floating_ip_enabled\": {\"description\": \"Whether enable or not using the floating IP of cloud provider. Some\\ncloud providers used floating IP, some used public IP, thus Magnum\\nprovide this option for specifying the choice of using floating IP.\\nIf it’s not set, the value of floating_ip_enabled in template\\nwill be used.\", \"format\": \"boolean\", \"type\": \"string\"}, \"health_status\": {\"enum\": [\"HEALTHY\", \"UNHEALTHY\", \"UNKNOWN\"], \"type\": \"string\"}, \"health_status_reason\": {\"additionalProperties\": {\"type\": \"string\"}, \"type\": \"object\"}, \"keypair\": {\"description\": \"The name of the SSH keypair to configure in the cluster servers\\nfor ssh access. Users will need the key to be able to ssh to the servers in\\nthe cluster. The login name is specific to the cluster driver, for\\nexample with fedora-atomic image, default login name is `fedora`.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"labels\": {\"additionalProperties\": {\"type\": [\"boolean\", \"integer\", \"number\", \"string\"]}, \"description\": \"Arbitrary labels in the form of `key=value` pairs. The accepted keys and\\nvalid values are defined in the cluster drivers. They are used as a way\\nto pass additional parameters that are specific to a cluster driver.\", \"type\": \"object\"}, \"labels_added\": {\"additionalProperties\": {\"type\": [\"boolean\", \"integer\", \"number\", \"string\"]}, \"type\": \"object\"}, \"labels_overridden\": {\"additionalProperties\": {\"type\": [\"boolean\", \"integer\", \"number\", \"string\"]}, \"type\": \"object\"}, \"labels_skipped\": {\"additionalProperties\": {\"type\": [\"boolean\", \"integer\", \"number\", \"string\"]}, \"type\": \"object\"}, \"links\": {\"items\": {\"description\": \"A link representation.\", \"properties\": {\"created_at\": {\"format\": \"date-time\", \"type\": \"string\"}, \"href\": {\"type\": \"string\"}, \"rel\": {\"type\": \"string\"}, \"type\": {\"type\": \"string\"}, \"updated_at\": {\"format\": \"date-time\", \"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"master_addresses\": {\"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"master_count\": {\"description\": \"The number of servers that will serve as master for the cluster. The\\ndefault is 1. Set to more than 1 master to enable High Availability. If\\nthe option `master-lb-enabled` is specified in the cluster\\ntemplate, the master servers will be placed in a load balancer pool.\", \"minimum\": 1, \"type\": \"integer\"}, \"master_flavor_id\": {\"description\": \"The flavor of the master node for this cluster template.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"master_lb_enabled\": {\"description\": \"Since multiple masters may exist in a cluster, a Neutron load balancer\\nis created to provide the API endpoint for the cluster and to direct\\nrequests to the masters. In some cases, such as when the LBaaS service is\\nnot available, this option can be set to `false` to create a cluster\\nwithout the load balancer. In this case, one of the masters will serve as\\nthe API endpoint. The default is `true`, i.e. to create the load\\nbalancer for the cluster.\", \"format\": \"boolean\", \"type\": \"string\"}, \"merge_labels\": {\"format\": \"boolean\", \"type\": \"string\"}, \"name\": {\"description\": \"Name of the resource.\", \"maxLength\": 242, \"minLength\": 1, \"type\": \"string\"}, \"node_addresses\": {\"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"node_count\": {\"description\": \"The number of servers that will serve as node in the cluster. The\\ndefault is 1.\", \"type\": \"integer\"}, \"project_id\": {\"type\": \"string\"}, \"stack_id\": {\"type\": \"string\"}, \"status\": {\"enum\": [\"ADOPT_COMPLETE\", \"CHECK_COMPLETE\", \"CREATE_COMPLETE\", \"CREATE_FAILED\", \"CREATE_IN_PROGRESS\", \"DELETE_COMPLETE\", \"DELETE_FAILED\", \"DELETE_IN_PROGRESS\", \"RESTORE_COMPLETE\", \"RESUME_COMPLETE\", \"RESUME_FAILED\", \"ROLLBACK_COMPLETE\", \"ROLLBACK_FAILED\", \"ROLLBACK_IN_PROGRESS\", \"SNAPSHOT_COMPLETE\", \"UPDATE_COMPLETE\", \"UPDATE_FAILED\", \"UPDATE_IN_PROGRESS\"], \"type\": \"string\"}, \"status_reason\": {\"type\": \"string\"}, \"updated_at\": {\"format\": \"date-time\", \"type\": \"string\"}, \"user_id\": {\"type\": \"string\"}, \"uuid\": {\"format\": \"uuid\", \"type\": \"string\"}}, \"required\": [\"cluster_template_id\"], \"type\": \"object\"}";
