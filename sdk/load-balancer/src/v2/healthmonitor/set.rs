...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("lbaas/healthmonitors/{id}", id = self.id.as_ref(),).into()
    }
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .healthmonitor(HealthmonitorBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::LoadBalancer
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/lbaas/healthmonitors/{id}", id = "id",));
