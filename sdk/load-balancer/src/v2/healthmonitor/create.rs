...
pub const BODY_SCHEMA: &str = "{\"description\": \"Base type for complex types\", \"properties\": {\"healthmonitor\": {\"description\": \"Defines mandatory and optional attributes of a POST request.\", \"properties\": {\"admin_state_up\": {\"description\": \"The administrative state of the resource, which is\\nup (`true`) or down (`false`). Default is `true`.\", \"type\": \"boolean\"}, \"delay\": {\"description\": \"The time, in seconds, between sending probes to members.\", \"type\": \"integer\"}, \"domain_name\": {\"description\": \"The domain name, which be injected into the HTTP Host Header to the backend\\nserver for HTTP health check.\\n\\n**New in version 2.10**\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"expected_codes\": {\"description\": \"The list of HTTP status codes expected in response from the member to\\ndeclare it healthy. Specify one of the following values:\\n\\n* A single value, such as `200`\\n* A list, such as `200, 202`\\n* A range, such as `200-204`\\n\\nThe default is 200.\", \"type\": \"string\"}, \"http_method\": {\"description\": \"The HTTP method that the health monitor uses for requests. One of\\n`CONNECT`, `DELETE`, `GET`, `HEAD`, `OPTIONS`, `PATCH`,\\n`POST`, `PUT`, or `TRACE`. The default is `GET`.\", \"enum\": [\"CONNECT\", \"DELETE\", \"GET\", \"HEAD\", \"OPTIONS\", \"PATCH\", \"POST\", \"PUT\", \"TRACE\"], \"type\": \"string\"}, \"http_version\": {\"description\": \"The HTTP version. One of `1.0` or `1.1`. The default is `1.0`.\\n\\n**New in version 2.10**\", \"enum\": [1.0, 1.1], \"type\": \"number\"}, \"max_retries\": {\"description\": \"The number of successful checks before changing the `operating status`\\nof the member to `ONLINE`. A valid value is from `1` to `10`.\", \"maximum\": 10, \"minimum\": 1, \"type\": \"integer\"}, \"max_retries_down\": {\"description\": \"The number of allowed check failures before changing the `operating\\nstatus` of the member to `ERROR`. A valid value is from `1` to `10`.\\nThe default is `3`.\", \"maximum\": 10, \"minimum\": 1, \"type\": \"integer\"}, \"name\": {\"description\": \"Human-readable name of the resource.\", \"maxLength\": 255, \"type\": \"string\"}, \"pool_id\": {\"description\": \"The ID of the pool.\", \"format\": \"uuid\", \"type\": \"string\"}, \"project_id\": {\"description\": \"The ID of the project owning this resource. (deprecated)\", \"maxLength\": 36, \"type\": \"string\"}, \"tags\": {\"description\": \"A list of simple strings assigned to the resource.\\n\\n**New in version 2.5**\", \"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}, \"tenant_id\": {\"maxLength\": 36, \"type\": \"string\"}, \"timeout\": {\"description\": \"The maximum time, in seconds, that a monitor waits to connect before it\\ntimes out. This value must be less than the delay value.\", \"type\": \"integer\"}, \"type\": {\"description\": \"The type of health monitor. One of `HTTP`, `HTTPS`, `PING`,\\n`SCTP`, `TCP`, `TLS-HELLO`, or `UDP-CONNECT`.\", \"enum\": [\"HTTP\", \"HTTPS\", \"PING\", \"SCTP\", \"TCP\", \"TLS-HELLO\", \"UDP-CONNECT\"], \"type\": \"string\"}, \"url_path\": {\"description\": \"The HTTP URL path of the request sent by the monitor to test the health of\\na backend member. Must be a string that begins with a forward slash\\n(`/`). The default URL path is `/`.\", \"format\": \"url_path\", \"type\": \"string\"}}, \"required\": [\"delay\", \"max_retries\", \"pool_id\", \"timeout\", \"type\"], \"type\": \"object\"}}, \"type\": \"object\"}";
