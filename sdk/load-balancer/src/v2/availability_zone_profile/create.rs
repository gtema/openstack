...
pub struct AvailabilityZoneProfile<'a> {
    #[serde()]
    #[builder(setter(into))]
    pub(crate) availability_zone_data: Cow<'a, str>,
    ...
    #[serde()]
    #[builder(setter(into))]
    pub(crate) provider_name: Cow<'a, str>,
}
...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            ...
            serde_json::to_value(&self.availability_zone_profile)?,
        );
    ...
    fn response_key(&self) -> Option<Cow<'static, str>> {
        Some("availability_zone_profile".into())
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Base type for complex types\", \"properties\": {\"availability_zone_profile\": {\"description\": \"Defines mandatory and optional attributes of a POST request.\", \"properties\": {\"availability_zone_data\": {\"maxLength\": 4096, \"type\": \"string\"}, \"name\": {\"maxLength\": 255, \"type\": \"string\"}, \"provider_name\": {\"maxLength\": 255, \"type\": \"string\"}}, \"required\": [\"availability_zone_data\", \"name\", \"provider_name\"], \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .availability_zone_profile(
                    AvailabilityZoneProfileBuilder::default()
                        .availability_zone_data("foo")
                        .name("foo")
                        .provider_name("foo")
                        .build()
                        .unwrap()
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path("/lbaas/availabilityzoneprofiles".to_string());

            then.status(200)
                .header("content-type", "application/json")
                .json_body(json!({ "availability_zone_profile": {} }));
        });
