...
pub struct AvailabilityZoneProfile<'a> {
    ...
    pub(crate) availability_zone_data: Option<Cow<'a, str>>,
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Base type for complex types\", \"properties\": {\"availability_zone_profile\": {\"description\": \"Defines the attributes of a PUT request.\", \"properties\": {\"availability_zone_data\": {\"maxLength\": 4096, \"type\": \"string\"}, \"name\": {\"maxLength\": 255, \"type\": \"string\"}, \"provider_name\": {\"maxLength\": 255, \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .availability_zone_profile(
                    AvailabilityZoneProfileBuilder::default().build().unwrap()
                )
                .build()
                .unwrap()
                .service_type(),
    ...
    fn endpoint() {
        ...
        let endpoint = Request::builder()
            .id("id")
            .availability_zone_profile(AvailabilityZoneProfileBuilder::default().build().unwrap())
            .build()
            .unwrap();
