...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("lbaas/flavors/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Base type for complex types\", \"properties\": {\"flavor\": {\"description\": \"Defines the attributes of a PUT request.\", \"properties\": {\"description\": {\"maxLength\": 255, \"type\": \"string\"}, \"enabled\": {\"type\": \"boolean\"}, \"name\": {\"maxLength\": 255, \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/lbaas/flavors/{id}", id = "id",));
