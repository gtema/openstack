...
pub const BODY_SCHEMA: &str = "{\"description\": \"Base type for complex types\", \"properties\": {\"pool\": {\"description\": \"Defines mandatory and optional attributes of a POST request.\", \"properties\": {\"admin_state_up\": {\"description\": \"The administrative state of the resource, which is\\nup (`true`) or down (`false`). Default is `true`.\", \"type\": \"boolean\"}, \"alpn_protocols\": {\"description\": \"A list of ALPN protocols.\\nAvailable protocols: http/1.0, http/1.1, h2\\n\\n**New in version 2.24**\", \"items\": {\"format\": \"alpn_protocol\", \"type\": \"string\"}, \"type\": \"array\"}, \"ca_tls_container_ref\": {\"description\": \"The reference of the [key manager service](https://docs.openstack.org/castellan/latest/) secret containing a\\nPEM format CA certificate bundle for `tls_enabled` pools.\\n\\n**New in version 2.8**\", \"maxLength\": 255, \"type\": \"string\"}, \"crl_container_ref\": {\"description\": \"The reference of the [key manager service](https://docs.openstack.org/castellan/latest/) secret containing a\\nPEM format CA revocation list file for `tls_enabled` pools.\", \"maxLength\": 255, \"type\": \"string\"}, \"description\": {\"description\": \"A human-readable description for the resource.\", \"maxLength\": 255, \"type\": \"string\"}, \"healthmonitor\": {\"description\": \"Defines mandatory and optional attributes of a POST request.\", \"properties\": {\"admin_state_up\": {\"type\": \"boolean\"}, \"delay\": {\"type\": \"integer\"}, \"domain_name\": {\"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"expected_codes\": {\"type\": \"string\"}, \"http_method\": {\"enum\": [\"CONNECT\", \"DELETE\", \"GET\", \"HEAD\", \"OPTIONS\", \"PATCH\", \"POST\", \"PUT\", \"TRACE\"], \"type\": \"string\"}, \"http_version\": {\"enum\": [1.0, 1.1], \"type\": \"number\"}, \"max_retries\": {\"maximum\": 10, \"minimum\": 1, \"type\": \"integer\"}, \"max_retries_down\": {\"maximum\": 10, \"minimum\": 1, \"type\": \"integer\"}, \"name\": {\"maxLength\": 255, \"type\": \"string\"}, \"tags\": {\"description\": \"A list of simple strings assigned to the resource.\\n\\n**New in version 2.5**\", \"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}, \"timeout\": {\"type\": \"integer\"}, \"type\": {\"enum\": [\"HTTP\", \"HTTPS\", \"PING\", \"SCTP\", \"TCP\", \"TLS-HELLO\", \"UDP-CONNECT\"], \"type\": \"string\"}, \"url_path\": {\"format\": \"url_path\", \"type\": \"string\"}}, \"required\": [\"delay\", \"max_retries\", \"timeout\", \"type\"], \"type\": \"object\"}, \"lb_algorithm\": {\"description\": \"The load balancing algorithm for the pool. One of `LEAST_CONNECTIONS`,\\n`ROUND_ROBIN`, `SOURCE_IP`, or `SOURCE_IP_PORT`.\", \"enum\": [\"LEAST_CONNECTIONS\", \"ROUND_ROBIN\", \"SOURCE_IP\", \"SOURCE_IP_PORT\"], \"type\": \"string\"}, \"listener_id\": {\"description\": \"The ID of the listener for the pool. Either `listener_id` or\\n`loadbalancer_id` must be specified. The listener has some restrictions,\\nSee [Protocol Combinations (Listener/Pool)](#valid-protocol).\", \"format\": \"uuid\", \"type\": \"string\"}, \"loadbalancer_id\": {\"description\": \"The ID of the load balancer for the pool. Either `listener_id` or\\n`loadbalancer_id` must be specified.\", \"format\": \"uuid\", \"type\": \"string\"}, \"members\": {\"items\": {\"description\": \"Defines mandatory and optional attributes of a POST request.\", \"properties\": {\"address\": {\"format\": \"ipaddress\", \"type\": \"string\"}, \"admin_state_up\": {\"type\": \"boolean\"}, \"backup\": {\"type\": \"boolean\"}, \"monitor_address\": {\"format\": \"ipaddress\", \"type\": \"string\"}, \"monitor_port\": {\"maximum\": 65535, \"minimum\": 1, \"type\": \"integer\"}, \"name\": {\"maxLength\": 255, \"type\": \"string\"}, \"protocol_port\": {\"maximum\": 65535, \"minimum\": 1, \"type\": \"integer\"}, \"request_sriov\": {\"type\": \"boolean\"}, \"subnet_id\": {\"format\": \"uuid\", \"type\": \"string\"}, \"tags\": {\"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}, \"weight\": {\"maximum\": 256, \"type\": \"integer\"}}, \"required\": [\"address\", \"protocol_port\"], \"type\": \"object\"}, \"type\": \"array\"}, \"name\": {\"description\": \"Human-readable name of the resource.\", \"maxLength\": 255, \"type\": \"string\"}, \"project_id\": {\"description\": \"The ID of the project owning this resource. (deprecated)\", \"maxLength\": 36, \"type\": \"string\"}, \"protocol\": {\"description\": \"The protocol for the resource. One of `HTTP`, `HTTPS`, `PROXY`,\\n`PROXYV2`, `SCTP`, `TCP`, or `UDP`.\", \"enum\": [\"HTTP\", \"HTTPS\", \"PROXY\", \"PROXYV2\", \"SCTP\", \"TCP\", \"UDP\"], \"type\": \"string\"}, \"session_persistence\": {\"description\": \"A JSON object specifying the session persistence for the pool or `null`\\nfor no session persistence. See [Pool Session Persistence](#session-persistence). Default is\\n`null`.\", \"properties\": {\"cookie_name\": {\"maxLength\": 255, \"type\": \"string\"}, \"persistence_granularity\": {\"format\": \"ipaddress\", \"type\": \"string\"}, \"persistence_timeout\": {\"type\": \"integer\"}, \"type\": {\"enum\": [\"APP_COOKIE\", \"HTTP_COOKIE\", \"SOURCE_IP\"], \"type\": \"string\"}}, \"required\": [\"type\"], \"type\": \"object\"}, \"tags\": {\"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}, \"tenant_id\": {\"maxLength\": 36, \"type\": \"string\"}, \"tls_ciphers\": {\"description\": \"List of ciphers in OpenSSL format (colon-separated).\\nSee <https://www.openssl.org/docs/man1.1.1/man1/ciphers.html>\\n\\n**New in version 2.15**\", \"maxLength\": 2048, \"type\": \"string\"}, \"tls_container_ref\": {\"description\": \"The reference to the [key manager service](https://docs.openstack.org/castellan/latest/) secret containing a\\nPKCS12 format certificate/key bundle for `tls_enabled` pools for\\nTLS client authentication to the member servers.\\n\\n**New in version 2.8**\", \"maxLength\": 255, \"type\": \"string\"}, \"tls_enabled\": {\"description\": \"When `true` connections to backend member servers will use TLS\\nencryption. Default is `false`.\\n\\n**New in version 2.8**\", \"type\": \"boolean\"}, \"tls_versions\": {\"description\": \"A list of TLS protocol versions.\\nAvailable versions: SSLv3, TLSv1, TLSv1.1, TLSv1.2, TLSv1.3\\n\\n**New in version 2.17**\", \"items\": {\"maxLength\": 32, \"type\": \"string\"}, \"type\": \"array\"}}, \"required\": [\"lb_algorithm\", \"protocol\"], \"type\": \"object\"}}, \"type\": \"object\"}";
