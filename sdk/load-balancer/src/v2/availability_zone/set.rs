...
pub const BODY_SCHEMA: &str = "{\"description\": \"Base type for complex types\", \"properties\": {\"availability_zone\": {\"description\": \"Defines the attributes of a PUT request.\", \"properties\": {\"description\": {\"maxLength\": 255, \"type\": \"string\"}, \"enabled\": {\"type\": \"boolean\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .availability_zone(AvailabilityZoneBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::LoadBalancer
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/lbaas/availabilityzones/{id}", id = "id",));
