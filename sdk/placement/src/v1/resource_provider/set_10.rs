...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("resource_providers/{uuid}", uuid = self.uuid.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"name\": {\"description\": \"The name of one resource provider.\", \"maxLength\": 200, \"type\": \"string\"}}, \"required\": [\"name\"], \"type\": \"object\", \"x-openstack\": {\"max-ver\": \"1.13\", \"min-ver\": \"1.0\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/resource_providers/{uuid}", uuid = "uuid",));
        ...
        let endpoint = Request::builder().uuid("uuid").name("foo").build().unwrap();
