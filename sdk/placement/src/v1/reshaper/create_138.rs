...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"allocations\": {\"additionalProperties\": false, \"description\": \"A dictionary of multiple allocations, keyed by consumer uuid. Each collection of allocations describes the full set of allocations for each consumer. Each consumer allocations dict is itself a dictionary of resource allocations keyed by resource provider uuid. An empty dictionary indicates no change in existing allocations, whereas an empty `allocations` dictionary **within** a consumer dictionary indicates that all allocations for that consumer should be deleted.\", \"minProperties\": 0, \"patternProperties\": {\"^[0-9a-fA-F-]{36}$\": {\"additionalProperties\": false, \"properties\": {\"allocations\": {\"additionalProperties\": false, \"description\": \"A dictionary of resource allocations keyed by resource provider uuid. If this is an empty object, allocations for this consumer will be removed.\", \"minProperties\": 0, \"patternProperties\": {\"^[0-9a-fA-F-]{36}$\": {\"additionalProperties\": false, \"properties\": {\"generation\": {\"type\": \"integer\"}, \"resources\": {\"additionalProperties\": false, \"description\": \"A dictionary of resource records keyed by resource class name.\", \"minProperties\": 1, \"patternProperties\": {\"^[A-Z0-9_]+$\": {\"minimum\": 1, \"type\": \"integer\"}}, \"type\": \"object\"}}, \"required\": [\"resources\"], \"type\": \"object\"}}, \"type\": \"object\"}, \"consumer_generation\": {\"description\": \"The generation of the consumer. Should be set to null when indicating that the caller expects the consumer does not yet exist.\", \"type\": [\"integer\", \"null\"]}, \"consumer_type\": {\"description\": \"A string that consists of numbers, A-Z, and _ describing what kind of consumer is creating, or has created, allocations using a quantity of inventory. The string is determined by the client when writing allocations and it is up to the client to ensure correct choices amongst collaborating services. For example, the compute service may choose to type some consumers ‘INSTANCE’ and others ‘MIGRATION’.\", \"maxLength\": 255, \"minLength\": 1, \"pattern\": \"^[A-Z0-9_]+$\", \"type\": \"string\"}, \"mappings\": {\"description\": \"A dictionary associating request group suffixes with a list of uuids identifying the resource providers that satisfied each group. The empty string and [a-zA-Z0-9_-]+ are valid suffixes. This field may be sent when writing allocations back to the server but will be ignored; this preserves symmetry between read and write representations.\", \"minProperties\": 1, \"patternProperties\": {\"[a-zA-Z0-9_-]{1,64}\": {\"items\": {\"format\": \"uuid\", \"type\": \"string\"}, \"minItems\": 1, \"type\": \"array\"}}, \"type\": \"object\"}, \"project_id\": {\"description\": \"The uuid of a project.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"user_id\": {\"description\": \"The uuid of a user.\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}}, \"required\": [\"allocations\", \"consumer_generation\", \"consumer_type\", \"project_id\", \"user_id\"], \"type\": \"object\"}}, \"type\": \"object\"}, \"inventories\": {\"additionalProperties\": false, \"description\": \"A dictionary of multiple inventories, keyed by resource provider uuid. Each inventory describes the desired full inventory for each resource provider. An empty dictionary causes the inventory for that provider to be deleted.\", \"minProperties\": 1, \"patternProperties\": {\"^[0-9a-fA-F-]{36}$\": {\"additionalProperties\": false, \"properties\": {\"inventories\": {\"description\": \"A dictionary of inventories keyed by resource classes.\", \"patternProperties\": {\"^[A-Z0-9_]+$\": {\"additionalProperties\": false, \"properties\": {\"allocation_ratio\": {\"type\": \"number\"}, \"max_unit\": {\"minimum\": 1, \"type\": \"integer\"}, \"min_unit\": {\"minimum\": 1, \"type\": \"integer\"}, \"reserved\": {\"minimum\": 0, \"type\": \"integer\"}, \"resource_provider_generation\": {\"type\": \"integer\"}, \"step_size\": {\"minimum\": 1, \"type\": \"integer\"}, \"total\": {\"minimum\": 1, \"type\": \"integer\"}}, \"required\": [\"total\"], \"type\": \"object\"}}, \"type\": \"object\"}, \"resource_provider_generation\": {\"description\": \"A consistent view marker that assists with the management of concurrent resource provider updates.\", \"type\": \"integer\"}}, \"required\": [\"inventories\", \"resource_provider_generation\"], \"type\": \"object\"}}, \"type\": \"object\"}}, \"required\": [\"allocations\", \"inventories\"], \"type\": \"object\", \"x-openstack\": {\"min-ver\": \"1.38\"}}";
