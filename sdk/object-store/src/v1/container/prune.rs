...
use openstack_sdk_core::{OpenStackError, RestError};

#[cfg(feature = "async")]
use openstack_sdk_core::api::{AsyncClient, QueryAsync};
// #[cfg(feature = "sync")]
// use crate::api::Client;

use crate::v1::{container::get::Request as ListRequest, object::delete::Request as DeleteRequest};
use openstack_sdk_core::api::{Pagination, ignore, paged};
