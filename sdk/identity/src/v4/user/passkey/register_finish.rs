...
pub const BODY_SCHEMA: &str = "{\"description\": \"A client response to a registration challenge. This contains all required\\ninformation to assess and assert trust in a credential's legitimacy,\\nfollowed by registration to a user.\\n\\nYou should not need to handle the inner content of this structure - you\\nshould provide this to the correctly handling function of Webauthn only.\\n<https://w3c.github.io/webauthn/#iface-pkcredential>.\", \"properties\": {\"description\": {\"description\": \"Optional credential description.\", \"maxLength\": 64, \"type\": \"string\"}, \"extensions\": {\"description\": \"<https://w3c.github.io/webauthn/#dictdef-authenticationextensionsclientoutputs> The default\\noption here for Options are None, so it can be derived.\", \"properties\": {\"appid\": {\"description\": \"Indicates whether the client used the provided appid extension.\", \"type\": \"boolean\"}, \"cred_props\": {\"description\": \"<https://www.w3.org/TR/webauthn-3/#sctn-authenticator-credential-properties-extension>.\", \"properties\": {\"rk\": {\"description\": \"A user agent supplied hint that this credential may have created a\\nresident key. It is returned from the user agent, not the\\nauthenticator meaning that this is an unreliable signal.\\n\\nNote that this extension is UNSIGNED and may have been altered by page\\njavascript.\", \"type\": [\"boolean\", \"null\"]}}, \"type\": \"object\"}, \"cred_protect\": {\"description\": \"Valid credential protection policies.\", \"enum\": [\"Optional\", \"OptionalWithCredentialIDList\", \"Required\"], \"type\": \"string\"}, \"hmac_secret\": {\"description\": \"Indicates if the client successfully applied a HMAC Secret.\", \"type\": \"boolean\"}, \"min_pin_length\": {\"description\": \"Indicates the current minimum PIN length.\", \"format\": \"int32\", \"minimum\": 0, \"type\": \"integer\"}}, \"type\": \"object\"}, \"id\": {\"description\": \"The id of the PublicKey credential, likely in base64.\\n\\nThis is NEVER actually used in a real registration, because the true\\ncredential ID is taken from the attestation data.\", \"type\": \"string\"}, \"raw_id\": {\"contentEncoding\": \"base64\", \"description\": \"The id of the credential, as binary.\\n\\nThis is NEVER actually used in a real registration, because the true\\ncredential ID is taken from the attestation data.\", \"format\": \"binary\", \"type\": \"string\"}, \"response\": {\"description\": \"<https://w3c.github.io/webauthn/#authenticatorattestationresponse>.\", \"properties\": {\"attestation_object\": {\"contentEncoding\": \"base64\", \"description\": \"<https://w3c.github.io/webauthn/#dom-authenticatorattestationresponse-attestationobject>.\", \"format\": \"binary\", \"type\": \"string\"}, \"client_data_json\": {\"contentEncoding\": \"base64\", \"description\": \"<https://w3c.github.io/webauthn/#dom-authenticatorresponse-clientdatajson>.\", \"format\": \"binary\", \"type\": \"string\"}, \"transports\": {\"description\": \"<https://w3c.github.io/webauthn/#dom-authenticatorattestationresponse-gettransports>.\", \"items\": {\"description\": \"<https://www.w3.org/TR/webauthn/#enumdef-authenticatortransport>.\", \"enum\": [\"Ble\", \"Hybrid\", \"Internal\", \"Nfc\", \"Test\", \"Unknown\", \"Usb\"], \"type\": \"string\"}, \"type\": \"array\"}}, \"required\": [\"attestation_object\", \"client_data_json\"], \"type\": \"object\"}, \"type_\": {\"description\": \"The type of credential.\", \"type\": \"string\"}}, \"required\": [\"id\", \"raw_id\", \"response\", \"type_\", \"extensions\"], \"type\": \"object\"}";
