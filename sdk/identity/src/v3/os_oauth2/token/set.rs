...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the OS-OAUTH2/token:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PATCH\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PATCH)
                .path("/OS-OAUTH2/token".to_string());
