...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"tags\": {\"description\": \"A list of simple strings assigned to a project.\", \"items\": {\"maxLength\": 255, \"minLength\": 1, \"pattern\": \"^[^,/]*$\", \"type\": \"string\"}, \"type\": \"array\"}}, \"type\": \"object\"}";
