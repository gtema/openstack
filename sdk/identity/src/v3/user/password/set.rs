...
pub const BODY_SCHEMA: &str = "{\"properties\": {\"user\": {\"additionalProperties\": false, \"description\": \"A `user` object\", \"properties\": {\"original_password\": {\"description\": \"The original password for the user.\", \"format\": \"password\", \"type\": \"string\"}, \"password\": {\"description\": \"The new password for the user.\", \"format\": \"password\", \"type\": \"string\"}}, \"required\": [\"original_password\", \"password\"], \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/users/{user_id}/password", user_id = "user_id",));
