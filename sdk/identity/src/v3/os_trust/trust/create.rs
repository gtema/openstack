...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"description\": \"A trust object\", \"properties\": {\"trust\": {\"additionalProperties\": true, \"properties\": {\"allow_redelegation\": {\"description\": \"If set to true then a trust between a trustor and any third-party user may be issued by the trustee just like a regular trust. If set to false, stops further redelegation. False by default.\", \"type\": [\"boolean\", \"null\"]}, \"expires_at\": {\"description\": \"Specifies the expiration time of the trust. A trust may be revoked ahead of expiration. If the value represents a time in the past, the trust is deactivated. In the redelegation case it must not exceed the value of the corresponding expires_at field of the redelegated trust or it may be omitted, then the expires_at value is copied from the redelegated trust.\", \"type\": [\"null\", \"string\"]}, \"impersonation\": {\"description\": \"If set to true, then the user attribute of tokens generated based on the trust will represent that of the trustor rather than the trustee, thus allowing the trustee to impersonate the trustor. If impersonation if set to false, then the token's user attribute will represent that of the trustee.\", \"type\": \"boolean\"}, \"project_id\": {\"description\": \"Identifies the project upon which the trustor is delegating authorization.\", \"type\": [\"null\", \"string\"]}, \"redelegated_trust_id\": {\"description\": \"Returned with redelegated trust provides information about the predecessor in the trust chain.\", \"type\": [\"null\", \"string\"]}, \"redelegation_count\": {\"description\": \"Specifies the maximum remaining depth of the redelegated trust chain. Each subsequent trust has this field decremented by 1 automatically. The initial trustor issuing new trust that can be redelegated, must set allow_redelegation to true and may set redelegation_count to an integer value less than or equal to max_redelegation_count configuration parameter in order to limit the possible length of derived trust chains. The trust issued by the trustor using a project-scoped token (not redelegating), in which allow_redelegation is set to true (the new trust is redelegatable), will be populated with the value specified in the max_redelegation_count configuration parameter if redelegation_count is not set or set to null. If allow_redelegation is set to false then redelegation_count will be set to 0 in the trust. If the trust is being issued by the trustee of a redelegatable trust-scoped token (redelegation case) then redelegation_count should not be set, as it will automatically be set to the value in the redelegatable trust-scoped token decremented by 1. Note, if the resulting value is 0, this means that the new trust will not be redelegatable, regardless of the value of allow_redelegation.\", \"minimum\": 0, \"type\": [\"integer\", \"null\"]}, \"remaining_uses\": {\"description\": \"Specifies how many times the trust can be used to obtain a token. This value is decreased each time a token is issued through the trust. Once it reaches 0, no further tokens will be issued through the trust. The default value is null, meaning there is no limit on the number of tokens issued through the trust. If redelegation is enabled it must not be set.\", \"minimum\": 1, \"type\": [\"integer\", \"null\"]}, \"roles\": {\"items\": {\"additionalProperties\": false, \"maxProperties\": 1, \"minProperties\": 1, \"properties\": {\"id\": {\"maxLength\": 64, \"minLength\": 1, \"pattern\": \"^[a-zA-Z0-9-]+$\", \"type\": \"string\"}, \"name\": {\"description\": \"The resource name.\", \"maxLength\": 255, \"minLength\": 1, \"pattern\": \"[\\\\S]+\", \"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"trustee_user_id\": {\"description\": \"Represents the user who is capable of consuming the trust.\", \"type\": \"string\"}, \"trustor_user_id\": {\"description\": \"Represents the user who created the trust, and who's authorization is being delegated.\", \"type\": \"string\"}}, \"required\": [\"impersonation\", \"trustee_user_id\", \"trustor_user_id\"], \"type\": \"object\"}}, \"required\": [\"trust\"], \"type\": \"object\"}";
