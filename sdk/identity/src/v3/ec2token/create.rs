...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Ec2Token.
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the ec2tokens:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"POST\"}}";
