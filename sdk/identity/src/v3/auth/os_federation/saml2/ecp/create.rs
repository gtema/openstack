...
pub const BODY_SCHEMA: &str = "{\"definitions\": {\"user_domain\": {\"description\": \"A `domain` object\", \"properties\": {\"id\": {\"description\": \"User Domain ID\", \"type\": \"string\"}, \"name\": {\"description\": \"User Domain Name\", \"type\": \"string\"}}, \"type\": \"object\"}}, \"properties\": {\"auth\": {\"description\": \"An `auth` object.\", \"properties\": {\"identity\": {\"description\": \"An `identity` object.\", \"properties\": {\"application_credential\": {\"description\": \"An application credential object.\", \"properties\": {\"id\": {\"description\": \"The ID of the application credential used for authentication. If not provided, the application credential must be identified by its name and its owning user.\", \"type\": \"string\"}, \"name\": {\"description\": \"The name of the application credential used for authentication. If provided, must be accompanied by a user object.\", \"type\": \"string\"}, \"secret\": {\"description\": \"The secret for authenticating the application credential.\", \"format\": \"password\", \"type\": \"string\"}, \"user\": {\"description\": \"A user object, required if an application credential is identified by name and not ID.\", \"properties\": {\"domain\": {\"description\": \"A `domain` object\", \"properties\": {\"id\": {\"description\": \"User Domain ID\", \"type\": \"string\"}, \"name\": {\"description\": \"User Domain Name\", \"type\": \"string\"}}, \"type\": \"object\"}, \"id\": {\"description\": \"The user ID\", \"type\": \"string\"}, \"name\": {\"description\": \"The user name\", \"type\": \"string\"}}, \"type\": \"object\"}}, \"required\": [\"secret\"], \"type\": \"object\"}, \"methods\": {\"description\": \"The authentication method. For password\\nauthentication, specify `password`.\", \"items\": {\"enum\": [\"application_credential\", \"password\", \"token\", \"totp\"], \"type\": \"string\"}, \"type\": \"array\"}, \"password\": {\"description\": \"The `password` object, contains the authentication information.\", \"properties\": {\"user\": {\"description\": \"A `user` object.\", \"properties\": {\"domain\": {\"description\": \"A `domain` object\", \"properties\": {\"id\": {\"description\": \"User Domain ID\", \"type\": \"string\"}, \"name\": {\"description\": \"User Domain Name\", \"type\": \"string\"}}, \"type\": \"object\"}, \"id\": {\"description\": \"The ID of the user. Required if you do not\\nspecify the user name.\", \"type\": \"string\"}, \"name\": {\"description\": \"The user name. Required if you do not specify\\nthe ID of the user. If you specify the user name, you must also\\nspecify the domain, by ID or name.\", \"type\": \"string\"}, \"password\": {\"description\": \"User Password\", \"format\": \"password\", \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}, \"token\": {\"description\": \"A `token` object\", \"properties\": {\"id\": {\"description\": \"Authorization Token value\", \"format\": \"password\", \"type\": \"string\"}}, \"required\": [\"id\"], \"type\": \"object\"}, \"totp\": {\"description\": \"Multi Factor Authentication information\", \"properties\": {\"user\": {\"properties\": {\"domain\": {\"description\": \"A `domain` object\", \"properties\": {\"id\": {\"description\": \"User Domain ID\", \"type\": \"string\"}, \"name\": {\"description\": \"User Domain Name\", \"type\": \"string\"}}, \"type\": \"object\"}, \"id\": {\"description\": \"The user ID\", \"type\": \"string\"}, \"name\": {\"description\": \"The user name\", \"type\": \"string\"}, \"passcode\": {\"description\": \"MFA passcode\", \"format\": \"password\", \"type\": \"string\"}}, \"required\": [\"passcode\"], \"type\": \"object\"}}, \"required\": [\"user\"], \"type\": \"object\"}}, \"required\": [\"methods\"], \"type\": \"object\"}, \"scope\": {\"description\": \"The authorization scope, including the system (Since v3.10), a project, or a domain (Since v3.4). If multiple scopes are specified in the same request (e.g. project and domain or domain and system) an HTTP 400 Bad Request will be returned, as a token cannot be simultaneously scoped to multiple authorization targets. An ID is sufficient to uniquely identify a project but if a project is specified by name, then the domain of the project must also be specified in order to uniquely identify the project by name. A domain scope may be specified by either the domain’s ID or name with equivalent results.\", \"properties\": {\"OS-TRUST:trust\": {\"properties\": {\"id\": {\"type\": \"string\"}}, \"type\": \"object\"}, \"domain\": {\"properties\": {\"id\": {\"description\": \"Domain id\", \"type\": \"string\"}, \"name\": {\"description\": \"Domain name\", \"type\": \"string\"}}, \"type\": \"object\"}, \"project\": {\"properties\": {\"domain\": {\"properties\": {\"id\": {\"description\": \"Project domain Id\", \"type\": \"string\"}, \"name\": {\"description\": \"Project domain Name\", \"type\": \"string\"}}, \"type\": \"object\"}, \"id\": {\"description\": \"Project Id\", \"type\": \"string\"}, \"name\": {\"description\": \"Project Name\", \"type\": \"string\"}}, \"type\": \"object\"}, \"system\": {\"properties\": {\"all\": {\"type\": \"boolean\"}}, \"type\": \"object\"}}, \"type\": \"object\"}}, \"required\": [\"identity\"], \"type\": \"object\"}}, \"type\": \"object\"}";
