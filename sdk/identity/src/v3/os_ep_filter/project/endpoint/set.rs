...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the OS-EP-FILTER/projects/project_id/endpoints/endpoint_id:put operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PUT\"}}";
