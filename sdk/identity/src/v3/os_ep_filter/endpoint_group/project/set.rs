...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "OS-EP-FILTER/endpoint_groups/{endpoint_group_id}/projects/{id}",
            endpoint_group_id = self.endpoint_group_id.as_ref(),
            id = self.id.as_ref(),
        )
        .into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the OS-EP-FILTER/endpoint_groups/endpoint_group_id/projects/project_id:put operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PUT\"}}";
