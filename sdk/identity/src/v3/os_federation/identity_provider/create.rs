...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"description\": \"An identity provider object\", \"properties\": {\"identity_provider\": {\"additionalProperties\": false, \"properties\": {\"authorization_ttl\": {\"description\": \"The length of validity in minutes for group memberships carried over through mapping and persisted in the database. If left unset, the default value configured in keystone will be used, if enabled.\", \"minimum\": 0, \"type\": [\"integer\", \"null\"]}, \"description\": {\"description\": \"The identity provider description\", \"type\": [\"null\", \"string\"]}, \"domain_id\": {\"description\": \"The ID of a domain that is associated with the identity provider. Federated users that authenticate with the identity provider will be created under the domain specified.\", \"maxLength\": 64, \"minLength\": 1, \"pattern\": \"^[a-zA-Z0-9-]+$\", \"type\": [\"null\", \"string\"]}, \"enabled\": {\"description\": \"Whether the identity provider is enabled or not\", \"enum\": [\"\", \"0\", \"1\", \"FALSE\", false, \"False\", \"N\", false, true, \"TRUE\", true, \"True\", \"Y\", \"false\", \"n\", false, false, true, \"true\", \"y\", true], \"type\": [\"boolean\", \"null\", \"string\"]}, \"remote_ids\": {\"description\": \"List of the unique identity provider's remote IDs\", \"items\": {\"maxLength\": 64, \"type\": \"string\"}, \"type\": [\"array\", \"null\"], \"uniqueItems\": true}}, \"type\": \"object\"}}, \"type\": \"object\"}";
