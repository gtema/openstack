...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("policies/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the policies/policy_id:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PATCH\"}}";
