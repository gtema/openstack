...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the policies/policy_id/OS-ENDPOINT-POLICY/services/service_id/regions/region_id:put operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PUT\"}}";
