...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "policies/{policy_id}/OS-ENDPOINT-POLICY/services/{id}",
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the policies/policy_id/OS-ENDPOINT-POLICY/services/service_id:put operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PUT\"}}";
