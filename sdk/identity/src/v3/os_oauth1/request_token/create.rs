...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Request_Token.
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        "OS-OAUTH1/request_token".to_string().into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the OS-OAUTH1/request_token:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"POST\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path("/OS-OAUTH1/request_token".to_string());
