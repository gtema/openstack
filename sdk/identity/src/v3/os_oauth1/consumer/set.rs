...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Consumer.
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("OS-OAUTH1/consumers/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the OS-OAUTH1/consumers/consumer_id:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PATCH\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PATCH)
                .path(format!("/OS-OAUTH1/consumers/{id}", id = "id",));
