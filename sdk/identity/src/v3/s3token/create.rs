...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the S3Token.
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the s3tokens:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"POST\"}}";
