...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the OS-INHERIT/domains/domain_id/groups/group_id/roles/role_id/inherited_to_projects:put operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"PUT\"}}";
