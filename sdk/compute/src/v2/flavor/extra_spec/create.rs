...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"extra_specs\": {\"additionalProperties\": false, \"description\": \"A dictionary of the flavor’s extra-specs key-and-value pairs. It appears\\nin the os-extra-specs’ “create” REQUEST body, as well as the\\nos-extra-specs’ “create” and “list” RESPONSE body.\", \"patternProperties\": {\"^[a-zA-Z0-9-_:. ]{1,255}$\": {\"maxLength\": 255, \"type\": [\"number\", \"string\"]}}, \"type\": \"object\"}}, \"required\": [\"extra_specs\"], \"type\": \"object\"}";
