...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"maxProperties\": 1, \"minProperties\": 1, \"patternProperties\": {\"^[a-zA-Z0-9-_:. ]{1,255}$\": {\"maxLength\": 255, \"type\": [\"number\", \"string\"]}}, \"type\": \"object\"}";
