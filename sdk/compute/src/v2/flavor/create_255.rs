...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"flavor\": {\"additionalProperties\": false, \"description\": \"The ID and links for the flavor for your server instance. A flavor is a combination\\nof memory, disk size, and CPUs.\", \"properties\": {\"OS-FLV-EXT-DATA:ephemeral\": {\"description\": \"The size of a dedicated swap disk that will be allocated, in\\nMiB. If 0 (the default), no dedicated swap disk will be created.\", \"maximum\": 2147483647, \"minimum\": 0, \"pattern\": \"^[0-9]+$\", \"type\": [\"integer\", \"string\"]}, \"description\": {\"description\": \"A free form description of the flavor. Limited to 65535 characters\\nin length. Only printable characters are allowed.\\n\\n**New in version 2.55**\", \"maxLength\": 65535, \"minLength\": 0, \"pattern\": \"^[\\\\ -\\\\~ -¬®-ͷͺ-Ϳ΄-ΊΌΎ-ΡΣ-ԯԱ-Ֆՙ-֊֍-֏֑-ׇא-תׯ-״؆-؛؝-ۜ۞-܍ܐ-݊ݍ-ޱ߀-ߺ߽-࠭࠰-࠾ࡀ-࡛࡞ࡠ-ࡪࡰ-ࢎ࢘-ࣣ࣡-ঃঅ-ঌএ-ঐও-নপ-রলশ-হ়-ৄে-ৈো-ৎৗড়-ঢ়য়-ৣ০-৾ਁ-ਃਅ-ਊਏ-ਐਓ-ਨਪ-ਰਲ-ਲ਼ਵ-ਸ਼ਸ-ਹ਼ਾ-ੂੇ-ੈੋ-੍ੑਖ਼-ੜਫ਼੦-੶ઁ-ઃઅ-ઍએ-ઑઓ-નપ-રલ-ળવ-હ઼-ૅે-ૉો-્ૐૠ-ૣ૦-૱ૹ-૿ଁ-ଃଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଵ-ହ଼-ୄେ-ୈୋ-୍୕-ୗଡ଼-ଢ଼ୟ-ୣ୦-୷ஂ-ஃஅ-ஊஎ-ஐஒ-கங-சஜஞ-டண-தந-பம-ஹா-ூெ-ைொ-்ௐௗ௦-௺ఀ-ఌఎ-ఐఒ-నప-హ఼-ౄె-ైొ-్ౕ-ౖౘ-ౚౝౠ-ౣ౦-౯౷-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹ಼-ೄೆ-ೈೊ-್ೕ-ೖೝ-ೞೠ-ೣ೦-೯ೱ-ೳഀ-ഌഎ-ഐഒ-ൄെ-ൈൊ-൏ൔ-ൣ൦-ൿඁ-ඃඅ-ඖක-නඳ-රලව-ෆ්ා-ුූෘ-ෟ෦-෯ෲ-෴ก-ฺ฿-๛ກ-ຂຄຆ-ຊຌ-ຣລວ-ຽເ-ໄໆ່-໎໐-໙ໜ-ໟༀ-ཇཉ-ཬཱ-ྗྙ-ྼ྾-࿌࿎-࿚က-ჅჇჍა-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚ፝-፼ᎀ-᎙Ꭰ-Ᏽᏸ-ᏽ᐀-᚜ᚠ-ᛸᜀ-᜕ᜟ-᜶ᝀ-ᝓᝠ-ᝬᝮ-ᝰᝲ-ᝳក-៝០-៩៰-៹᠀-᠍᠏-᠙ᠠ-ᡸᢀ-ᢪᢰ-ᣵᤀ-ᤞᤠ-ᤫᤰ-᤻᥀᥄-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉ᧐-᧚᧞-ᨛ᨞-ᩞ᩠-᩿᩼-᪉᪐-᪙᪠-᪭᪰-ᫎᬀ-ᭌ᭐-᭾ᮀ-᯳᯼-᰷᰻-᱉ᱍ-ᲈᲐ-ᲺᲽ-᳇᳐-ᳺᴀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ῄῆ-ΐῖ-Ί῝-`ῲ-ῴῶ-῾ - ‐-‧ - ⁰-ⁱ⁴-₎ₐ-ₜ₠-⃀⃐-⃰℀-↋←-␦⑀-⑊①-⭳⭶-⮕⮗-ⳳ⳹-ⴥⴧⴭⴰ-ⵧⵯ-⵰⵿-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞⷠ-⹝⺀-⺙⺛-⻳⼀-⿕⿰-⿻　-〿ぁ-ゖ゙-ヿㄅ-ㄯㄱ-ㆎ㆐-㇣ㇰ-㈞㈠-ꒌ꒐-꓆ꓐ-ꘫꙀ-꛷꜀-ꟊꟐ-ꟑꟓꟕ-ꟙꟲ-꠬꠰-꠹ꡀ-꡷ꢀ-ꣅ꣎-꣙꣠-꥓꥟-ꥼꦀ-꧍ꧏ-꧙꧞-ꧾꨀ-ꨶꩀ-ꩍ꩐-꩙꩜-ꫂꫛ-꫶ꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-꭫ꭰ-꯭꯰-꯹가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִ-זּטּ-לּמּנּ-סּףּ-פּצּ-﯂ﯓ-ﶏﶒ-ﷇ﷏ﷰ-︙︠-﹒﹔-﹦﹨-﹫ﹰ-ﹴﹶ-ﻼ！-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ￠-￦￨-￮￼-�]*$\", \"type\": [\"null\", \"string\"]}, \"disk\": {\"description\": \"The size of a dedicated swap disk that will be allocated, in\\nMiB. If 0 (the default), no dedicated swap disk will be created.\", \"maximum\": 2147483647, \"minimum\": 0, \"pattern\": \"^[0-9]+$\", \"type\": [\"integer\", \"string\"]}, \"id\": {\"description\": \"Only alphanumeric characters with hyphen ‘-’, underscore ‘_’, spaces\\nand dots ‘.’ are permitted. If an ID is not provided, then a default UUID\\nwill be assigned.\", \"maxLength\": 255, \"minLength\": 1, \"pattern\": \"^(?! )[a-zA-Z0-9. _-]+(?<! )$\", \"type\": [\"null\", \"number\", \"string\"]}, \"name\": {\"description\": \"The display name of a flavor.\", \"format\": \"name\", \"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"os-flavor-access:is_public\": {\"description\": \"Whether the flavor is public (available to all projects) or scoped\\nto a set of projects. Default is True if not specified.\", \"enum\": [\"0\", \"1\", \"FALSE\", false, \"False\", false, false, false, true, false, true, \"TRUE\", true, \"True\", true, true, \"false\", false, false, true, \"true\", true], \"type\": [\"boolean\", \"string\"]}, \"ram\": {\"description\": \"The number of virtual CPUs that will be allocated to the server.\", \"maximum\": 2147483647, \"minimum\": 1, \"pattern\": \"^[0-9]+$\", \"type\": [\"integer\", \"string\"]}, \"rxtx_factor\": {\"description\": \"The receive / transmit factor (as a float) that will be set on\\nports if the network backend supports the QOS extension.\\nOtherwise it will be ignored. It defaults to 1.0.\\n\\n**Available until version 2.101**\", \"exclusiveMinimum\": 0, \"maximum\": 3.40282e+38, \"pattern\": \"^[0-9]+(\\\\.[0-9]+)?$\", \"type\": [\"number\", \"string\"]}, \"swap\": {\"description\": \"The size of a dedicated swap disk that will be allocated, in\\nMiB. If 0 (the default), no dedicated swap disk will be created.\", \"maximum\": 2147483647, \"minimum\": 0, \"pattern\": \"^[0-9]+$\", \"type\": [\"integer\", \"string\"]}, \"vcpus\": {\"description\": \"The number of virtual CPUs that will be allocated to the server.\", \"maximum\": 2147483647, \"minimum\": 1, \"pattern\": \"^[0-9]+$\", \"type\": [\"integer\", \"string\"]}}, \"required\": [\"disk\", \"name\", \"ram\", \"vcpus\"], \"type\": \"object\"}}, \"required\": [\"flavor\"], \"type\": \"object\", \"x-openstack\": {\"max-ver\": \"2.101\", \"min-ver\": \"2.55\"}}";
