...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"description\": \"Pauses a server. Changes its status to `PAUSED`.\\n\\nSpecify the `pause` action in the request body.\\n\\nPolicy defaults enable only users with the administrative role or\\nthe owner of the server to perform this operation. Cloud providers\\ncan change these permissions through the `policy.yaml` file.\\n\\nNormal response codes: 202\\n\\nError response codes: unauthorized(401), forbidden(403), itemNotFound(404),\\nconflict(409), notImplemented(501)\", \"properties\": {\"pause\": {}}, \"required\": [\"pause\"], \"summary\": \"Pause Server (pause Action)\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"pause\"}}";
