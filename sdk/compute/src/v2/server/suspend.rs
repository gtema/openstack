...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("suspend", serde_json::to_value(&self.suspend)?);
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"description\": \"Suspends a server and changes its status to `SUSPENDED`.\\n\\nSpecify the `suspend` action in the request body.\\n\\nPolicy defaults enable only users with the administrative role or\\nthe owner of the server to perform this operation. Cloud providers\\ncan change these permissions through the `policy.yaml` file.\\n\\nNormal response codes: 202\\n\\nError response codes: unauthorized(401), forbidden(403), itemNotFound(404),\\nconflict(409)\", \"properties\": {\"suspend\": {}}, \"required\": [\"suspend\"], \"summary\": \"Suspend Server (suspend Action)\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"suspend\"}}";
