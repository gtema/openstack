...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("unlock", serde_json::to_value(&self.unlock)?);
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"description\": \"Unlocks a locked server.\\n\\nSpecify the `unlock` action in the request body.\\n\\nPolicy defaults enable only users with the administrative role or\\nthe owner of the server to perform this operation. Cloud providers\\ncan change these permissions through the `policy.yaml` file.\\n\\nNormal response codes: 202\\n\\nError response codes: unauthorized(401), forbidden(403), itemNotFound(404)\", \"properties\": {\"unlock\": {}}, \"required\": [\"unlock\"], \"summary\": \"Unlock Server (unlock Action)\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"unlock\", \"max-ver\": \"2.72\", \"min-ver\": \"2.1\"}}";
