...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"lock\": {}}, \"required\": [\"lock\"], \"summary\": \"Lock Server (lock Action)\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"lock\", \"max-ver\": \"2.72\", \"min-ver\": \"2.1\"}}";
...
mod tests {
    ...
    fn endpoint() {
        ...
        let endpoint = Request::builder().id("id").lock(json!({})).build().unwrap();
