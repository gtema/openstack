...
pub struct Request<'a> {
    ...
    #[builder(setter(into))]
    pub(crate) inject_network_info: Value,
...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            "injectNetworkInfo",
            serde_json::to_value(&self.inject_network_info)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"description\": \"Injects network information into a server.\\n\\nSpecify the `injectNetworkInfo` action in the request body.\\n\\nPolicy defaults enable only users with the administrative role to\\nperform this operation. Cloud providers can change these permissions\\nthrough the `policy.yaml` file.\\n\\nNormal response codes: 202\\n\\nError response codes: unauthorized(401), forbidden(403), itemNotFound(404), conflict(409)\", \"properties\": {\"injectNetworkInfo\": {}}, \"required\": [\"injectNetworkInfo\"], \"summary\": \"Inject Network Information (injectNetworkInfo Action)\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"injectNetworkInfo\"}}";
