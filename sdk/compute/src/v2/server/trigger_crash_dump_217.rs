...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"trigger_crash_dump\": {\"type\": \"null\"}}, \"required\": [\"trigger_crash_dump\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"trigger_crash_dump\", \"min-ver\": \"2.17\"}}";
