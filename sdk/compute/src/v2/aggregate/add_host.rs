...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"add_host\": {\"additionalProperties\": false, \"properties\": {\"host\": {\"maxLength\": 255, \"minLength\": 1, \"pattern\": \"^[a-zA-Z0-9-._]*$\", \"type\": \"string\"}}, \"required\": [\"host\"], \"type\": \"object\"}}, \"required\": [\"add_host\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"add_host\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/os-aggregates/{id}/action", id = "id",));
