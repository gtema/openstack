...
pub struct Request<'a> {
    ...
    zone_transfer_request_id: Cow<'a, str>,
...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Transfer_Request.
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "zones/tasks/transfer_requests/{zone_transfer_request_id}",
            zone_transfer_request_id = self.zone_transfer_request_id.as_ref(),
        )
        .into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/tasks/transfer_requests/zone_transfer_request_id:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"update\"}}";
