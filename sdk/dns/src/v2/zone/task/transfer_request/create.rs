...
pub struct Request<'a> {
    /// zone_id parameter for /v2/zones/{zone_id}/tasks/transfer_requests API
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/zone_id/tasks/transfer_requests:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
