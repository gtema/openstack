...
//!
//! This moves a zone from the existing designate pool to specified target
//! pool. If pool is not specified by admin, designate will determine suitable
//! pool by itself and move zone to that pool.
//!
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/zone_id/tasks/pool_move:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
