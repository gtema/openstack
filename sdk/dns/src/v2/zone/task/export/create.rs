...
pub struct Request<'a> {
    /// zone_id parameter for /v2/zones/{zone_id}/tasks/export API
...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Export.
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/zone_id/tasks/export:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
