...
pub struct Request<'a> {
    /// zone_id parameter for /v2/zones/{zone_id}/tasks/xfr API
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("zones/{zone_id}/tasks/xfr", zone_id = self.zone_id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/zone_id/tasks/xfr:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/zones/{zone_id}/tasks/xfr", zone_id = "zone_id",));
