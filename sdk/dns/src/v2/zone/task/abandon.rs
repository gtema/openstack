...
//! Abandon a zone.
//!
//! This removes a zone from the designate database without removing it from
//! the backends.
//!
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/zone_id/tasks/abandon:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
