...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        "zones/tasks/imports".to_string().into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/tasks/imports:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
