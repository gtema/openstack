...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Transfer_Accept.
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the zones/tasks/transfer_accepts:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path("/zones/tasks/transfer_accepts".to_string());
