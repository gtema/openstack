...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Blacklist.
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("blacklists/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the blacklists/blacklist_id:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"update\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PATCH)
                .path(format!("/blacklists/{id}", id = "id",));
