...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("pools/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the pools/pool_id:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"update\"}}";
