...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Tsigkey.
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("tsigkeys/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the tsigkeys/tsigkey_id:patch operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"update\"}}";
