...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the tsigkeys:post operation\", \"type\": \"object\", \"x-openstack\": {\"action-name\": \"create\"}}";
