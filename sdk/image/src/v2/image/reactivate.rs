...
//!
//! The reactivate operation returns an error if the image status is not
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the images/image_id/actions/reactivate:post operation\", \"type\": \"object\"}";
