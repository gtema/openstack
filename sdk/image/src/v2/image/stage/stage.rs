...
//! Places the binary image data in a staging area. It is not stored in the
//! storage backend and is not accessible for download until after the
//! [Image Import](#image-import-call) call is made. *(Since Image API v2.6)*
//!
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("images/{image_id}/stage", image_id = self.image_id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the images/image_id/stage:put operation\", \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/images/{image_id}/stage", image_id = "image_id",));
