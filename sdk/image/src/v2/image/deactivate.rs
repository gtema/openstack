...
//!
//! The deactivate operation returns an error if the image status is not
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the images/image_id/actions/deactivate:post operation\", \"type\": \"object\"}";
