...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Cache.
...
pub const BODY_SCHEMA: &str =
    "{\"description\": \"Request of the cache/image_id:put operation\", \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/cache/{image_id}", image_id = "image_id",));
