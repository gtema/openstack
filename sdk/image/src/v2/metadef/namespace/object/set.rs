...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "metadefs/namespaces/{namespace_name}/objects/{object_name}",
            namespace_name = self.namespace_name.as_ref(),
            object_name = self.object_name.as_ref(),
        )
        .into()
    }
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"created_at\": {\"description\": \"Date and time of object creation\", \"format\": \"date-time\", \"readOnly\": true, \"type\": \"string\"}, \"description\": {\"type\": \"string\"}, \"name\": {\"maxLength\": 80, \"type\": \"string\"}, \"properties\": {\"additionalProperties\": {\"properties\": {\"additionalItems\": {\"type\": \"boolean\"}, \"default\": {}, \"description\": {\"type\": \"string\"}, \"enum\": {\"type\": \"array\"}, \"items\": {\"properties\": {\"enum\": {\"type\": \"array\"}, \"type\": {\"enum\": [null, \"array\", \"boolean\", \"integer\", \"number\", \"object\", \"string\"], \"type\": \"string\"}}, \"type\": \"object\"}, \"maxItems\": {\"minimum\": 0, \"type\": \"integer\"}, \"maxLength\": {\"minimum\": 0, \"type\": \"integer\"}, \"maximum\": {\"type\": \"number\"}, \"minItems\": {\"allOf\": [{\"default\": 0}, {\"minimum\": 0, \"type\": \"integer\"}]}, \"minLength\": {\"allOf\": [{\"default\": 0}, {\"minimum\": 0, \"type\": \"integer\"}]}, \"minimum\": {\"type\": \"number\"}, \"name\": {\"maxLength\": 80, \"type\": \"string\"}, \"operators\": {\"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"pattern\": {\"format\": \"regex\", \"type\": \"string\"}, \"readonly\": {\"type\": \"boolean\"}, \"required\": {\"items\": {\"type\": \"string\"}, \"type\": \"array\", \"uniqueItems\": true}, \"title\": {\"type\": \"string\"}, \"type\": {\"enum\": [null, \"array\", \"boolean\", \"integer\", \"number\", \"object\", \"string\"], \"type\": \"string\"}, \"uniqueItems\": {\"default\": false, \"type\": \"boolean\"}}, \"required\": [\"title\", \"type\"], \"type\": \"object\"}, \"type\": \"object\"}, \"required\": {\"items\": {\"type\": \"string\"}, \"type\": \"array\", \"uniqueItems\": true}, \"schema\": {\"readOnly\": true, \"type\": \"string\"}, \"self\": {\"readOnly\": true, \"type\": \"string\"}, \"updated_at\": {\"description\": \"Date and time of the last object modification\", \"format\": \"date-time\", \"readOnly\": true, \"type\": \"string\"}}, \"required\": [\"name\"], \"type\": \"object\"}";
