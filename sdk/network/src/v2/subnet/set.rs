...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the subnets/subnet_id:put operation\", \"properties\": {\"subnet\": {\"properties\": {\"allocation_pools\": {\"description\": \"Allocation pools with `start` and `end` IP addresses\\nfor this subnet. If allocation_pools are not specified, OpenStack\\nNetworking automatically allocates pools for covering all IP addresses\\nin the CIDR, excluding the address reserved for the subnet gateway by\\ndefault.\", \"items\": {\"properties\": {\"end\": {\"type\": \"string\"}, \"start\": {\"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"description\": {\"description\": \"A human-readable description for the resource.\\nDefault is an empty string.\", \"maxLength\": 255, \"type\": \"string\"}, \"dns_nameservers\": {\"description\": \"List of dns name servers associated with the subnet. Default is an\\nempty list.\", \"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"dns_publish_fixed_ip\": {\"description\": \"Whether to publish DNS records for IPs from this subnet. Default\\nis `false`.\", \"type\": [\"boolean\", \"string\"]}, \"enable_dhcp\": {\"description\": \"Indicates whether dhcp is enabled or disabled\\nfor the subnet. Default is `true`.\", \"type\": [\"boolean\", \"string\"]}, \"gateway_ip\": {\"description\": \"Gateway IP of this subnet. If the value is `null` that implies no\\ngateway is associated with the subnet.\", \"type\": [\"null\", \"string\"]}, \"host_routes\": {\"description\": \"Additional routes for the subnet. A list of dictionaries with\\n`destination` and `nexthop` parameters. Default value is\\nan empty list.\", \"items\": {\"properties\": {\"destination\": {\"type\": \"string\"}, \"nexthop\": {\"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"name\": {\"description\": \"Human-readable name of the resource.\", \"type\": \"string\"}, \"segment_id\": {\"description\": \"The ID of a network segment the subnet is associated with.\\nIt is available when `segment` extension is enabled.\", \"format\": \"uuid\", \"type\": [\"null\", \"string\"]}, \"service_types\": {\"description\": \"The service types associated with the subnet.\", \"items\": {\"type\": \"string\"}, \"type\": \"array\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
