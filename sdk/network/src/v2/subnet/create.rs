...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the subnets:post operation\", \"properties\": {\"subnet\": {\"description\": \"A `subnet` object.\", \"properties\": {\"allocation_pools\": {\"description\": \"Allocation pools with `start` and `end` IP addresses\\nfor this subnet. If allocation_pools are not specified, OpenStack\\nNetworking automatically allocates pools for covering all IP addresses\\nin the CIDR, excluding the address reserved for the subnet gateway by\\ndefault.\", \"items\": {\"properties\": {\"end\": {\"type\": \"string\"}, \"start\": {\"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"cidr\": {\"description\": \"The CIDR of the subnet.\", \"type\": [\"null\", \"string\"]}, \"description\": {\"description\": \"A human-readable description for the resource.\\nDefault is an empty string.\", \"maxLength\": 255, \"type\": \"string\"}, \"dns_nameservers\": {\"description\": \"List of dns name servers associated with the subnet. Default is an\\nempty list.\", \"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"dns_publish_fixed_ip\": {\"description\": \"Whether to publish DNS records for IPs from this subnet. Default\\nis `false`.\", \"type\": [\"boolean\", \"string\"]}, \"enable_dhcp\": {\"description\": \"Indicates whether dhcp is enabled or disabled\\nfor the subnet. Default is `true`.\", \"type\": [\"boolean\", \"string\"]}, \"gateway_ip\": {\"description\": \"Gateway IP of this subnet. If the value is `null` that implies no\\ngateway is associated with the subnet. If the gateway_ip is not\\nspecified, OpenStack Networking allocates an address from the CIDR\\nfor the gateway for the subnet by default.\", \"type\": [\"null\", \"string\"]}, \"host_routes\": {\"description\": \"Additional routes for the subnet. A list of dictionaries with\\n`destination` and `nexthop` parameters. Default value is\\nan empty list.\", \"items\": {\"properties\": {\"destination\": {\"type\": \"string\"}, \"nexthop\": {\"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"ip_version\": {\"description\": \"The IP protocol version. Value is `4` or `6`.\", \"enum\": [4, 6], \"type\": [\"integer\", \"string\"]}, \"ipv6_address_mode\": {\"description\": \"The IPv6 address modes specifies mechanisms for assigning IP addresses.\\nValue is `slaac`, `dhcpv6-stateful`, `dhcpv6-stateless` or `null`.\", \"enum\": [null, \"dhcpv6-stateful\", \"dhcpv6-stateless\", \"slaac\"], \"type\": [\"null\", \"string\"]}, \"ipv6_ra_mode\": {\"description\": \"The IPv6 router advertisement specifies whether the networking service\\nshould transmit ICMPv6 packets, for a subnet. Value is `slaac`,\\n`dhcpv6-stateful`, `dhcpv6-stateless` or `null`.\", \"enum\": [null, \"dhcpv6-stateful\", \"dhcpv6-stateless\", \"slaac\"], \"type\": [\"null\", \"string\"]}, \"name\": {\"description\": \"Human-readable name of the resource. Default is an empty string.\", \"type\": \"string\"}, \"network_id\": {\"description\": \"The ID of the network to which the subnet belongs.\", \"format\": \"uuid\", \"type\": \"string\"}, \"prefixlen\": {\"description\": \"The prefix length to use for subnet allocation from a subnet pool.\\nIf not specified, the `default_prefixlen` value of the subnet pool\\nwill be used.\", \"minimum\": 0, \"type\": [\"integer\", \"string\"]}, \"segment_id\": {\"description\": \"The ID of a network segment the subnet is associated with.\\nIt is available when `segment` extension is enabled.\", \"format\": \"uuid\", \"type\": [\"null\", \"string\"]}, \"service_types\": {\"description\": \"The service types associated with the subnet.\", \"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"subnetpool_id\": {\"description\": \"The ID of the subnet pool associated with the subnet.\", \"type\": [\"null\", \"string\"]}, \"tenant_id\": {\"description\": \"The ID of the project that owns the resource.\\nOnly administrative and users with advsvc role can specify\\na project ID other than their own.\\nYou cannot change this value through authorization policies.\", \"maxLength\": 255, \"type\": \"string\"}, \"use_default_subnetpool\": {\"description\": \"Whether to allocate this subnet from the default subnet pool.\", \"type\": [\"boolean\", \"string\"]}}, \"required\": [\"ip_version\", \"network_id\"], \"type\": \"object\"}}, \"type\": \"object\"}";
