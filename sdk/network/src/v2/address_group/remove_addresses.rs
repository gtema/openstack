...
pub const BODY_SCHEMA: &str = "{\"properties\": {\"address_group\": {\"properties\": {\"addresses\": {\"description\": \"A list of IP addresses.\", \"items\": {\"type\": \"string\"}, \"type\": \"array\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/address-groups/{id}/remove_addresses", id = "id",));
