...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("log/loggable-resources/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the log/loggable-resources/id:put operation\", \"properties\": {\"loggable_resource\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/log/loggable-resources/{id}", id = "id",));
