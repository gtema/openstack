...
impl<'a> RequestBuilder<'a> {
    pub fn network_ip_availability<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
    {
        self.network_ip_availability
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("network-ip-availabilities/{id}", id = self.id.as_ref(),).into()
    }
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            ...
            serde_json::to_value(&self.network_ip_availability)?,
        );
    ...
    fn response_key(&self) -> Option<Cow<'static, str>> {
        Some("network_ip_availability".into())
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the network-ip-availabilities/id:put operation\", \"properties\": {\"network_ip_availability\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .network_ip_availability(BTreeMap::<String, Value>::new().into_iter())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/network-ip-availabilities/{id}", id = "id",));

            then.status(200)
                .header("content-type", "application/json")
                .json_body(json!({ "network_ip_availability": {} }));
        });
