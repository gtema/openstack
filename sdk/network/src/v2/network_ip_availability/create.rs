...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the network-ip-availabilities:post operation\", \"properties\": {\"network_ip_availability\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path("/network-ip-availabilities".to_string());
