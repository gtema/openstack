...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("ndp-proxies/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the ndp-proxies/id:put operation\", \"properties\": {\"ndp_proxy\": {\"properties\": {\"description\": {\"maxLength\": 255, \"type\": \"string\"}, \"name\": {\"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/ndp-proxies/{id}", id = "id",));
