...
pub struct Request<'a> {
    #[builder(setter(into))]
    pub(crate) ndp_proxy: NdpProxy<'a>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("ndp_proxy", serde_json::to_value(&self.ndp_proxy)?);
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the ndp-proxies:post operation\", \"properties\": {\"ndp_proxy\": {\"properties\": {\"description\": {\"maxLength\": 255, \"type\": \"string\"}, \"ip_address\": {\"type\": [\"null\", \"string\"]}, \"name\": {\"type\": \"string\"}, \"port_id\": {\"format\": \"uuid\", \"type\": \"string\"}, \"project_id\": {\"maxLength\": 255, \"type\": \"string\"}, \"router_id\": {\"format\": \"uuid\", \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .ndp_proxy(NdpProxyBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
