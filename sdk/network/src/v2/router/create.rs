...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the routers:post operation\", \"properties\": {\"router\": {\"description\": \"A `router` object.\", \"properties\": {\"admin_state_up\": {\"description\": \"The administrative state of the resource, which is\\nup (`true`) or down (`false`).\\nDefault is `true`.\", \"type\": [\"boolean\", \"string\"]}, \"availability_zone_hints\": {\"description\": \"The availability zone candidates for the router.\\nIt is available when `router_availability_zone` extension is enabled.\", \"items\": {\"type\": \"string\"}, \"type\": \"array\"}, \"description\": {\"description\": \"A human-readable description for the resource.\\nDefault is an empty string.\", \"maxLength\": 255, \"type\": \"string\"}, \"distributed\": {\"description\": \"`true` indicates a distributed router.\\nIt is available when `dvr` extension is enabled.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"enable_ndp_proxy\": {\"description\": \"Enable NDP proxy attribute. Default is `false`, To persist this attribute\\nvalue, set the `enable_ndp_proxy_by_default` option in the\\n`neutron.conf` file. It is available when `router-extend-ndp-proxy`\\nextension is enabled.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"external_gateway_info\": {\"description\": \"The external gateway information of the router.\\nIf the router has an external gateway, this would be a dict with\\n`network_id`, `enable_snat`, `external_fixed_ips` and\\n`qos_policy_id`.\\nOtherwise, this would be `null`.\", \"properties\": {\"enable_snat\": {\"type\": [\"boolean\", \"string\"]}, \"external_fixed_ips\": {\"items\": {\"properties\": {\"ip_address\": {\"description\": \"IP Address\", \"type\": \"string\"}, \"subnet_id\": {\"description\": \"The subnet ID from which the IP address is assigned\", \"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"network_id\": {\"format\": \"uuid\", \"type\": \"string\"}, \"qos_policy_id\": {\"format\": \"uuid\", \"type\": [\"null\", \"string\"]}}, \"required\": [\"network_id\"], \"type\": [\"null\", \"object\"]}, \"flavor_id\": {\"description\": \"The ID of the flavor associated with the router.\", \"type\": \"string\"}, \"ha\": {\"description\": \"`true` indicates a highly-available router.\\nIt is available when `l3-ha` extension is enabled.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"name\": {\"description\": \"Human-readable name of the resource.\\nDefault is an empty string.\", \"type\": \"string\"}, \"tenant_id\": {\"description\": \"The ID of the project that owns the resource.\\nOnly administrative and users with advsvc role can specify\\na project ID other than their own.\\nYou cannot change this value through authorization policies.\", \"maxLength\": 255, \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
