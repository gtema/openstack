...
//! (`evpn_vni` is not null), the `advertise_host` parameter can be set to
//! `true` to instruct the EVPN plugin to advertise connected routes from this
//! subnet as host routes via EVPN Type-5.
//!
