...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("routers/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the routers/id:put operation\", \"properties\": {\"router\": {\"description\": \"A `router` object.\", \"properties\": {\"admin_state_up\": {\"description\": \"The administrative state of the resource, which is\\nup (`true`) or down (`false`).\", \"type\": [\"boolean\", \"string\"]}, \"description\": {\"description\": \"A human-readable description for the resource.\\nDefault is an empty string.\", \"maxLength\": 255, \"type\": \"string\"}, \"distributed\": {\"description\": \"`true` indicates a distributed router.\\nIt is available when `dvr` extension is enabled.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"enable_ndp_proxy\": {\"description\": \"Enable NDP proxy attribute. Default is `false`, To persist this attribute\\nvalue, set the `enable_ndp_proxy_by_default` option in the\\n`neutron.conf` file. It is available when `router-extend-ndp-proxy`\\nextension is enabled.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"external_gateway_info\": {\"description\": \"The external gateway information of the router.\\nIf the router has an external gateway, this would be a dict with\\n`network_id`, `enable_snat`, `external_fixed_ips` and\\n`qos_policy_id`.\\nOtherwise, this would be `null`.\", \"properties\": {\"enable_snat\": {\"type\": [\"boolean\", \"string\"]}, \"external_fixed_ips\": {\"items\": {\"properties\": {\"ip_address\": {\"description\": \"IP Address\", \"type\": \"string\"}, \"subnet_id\": {\"description\": \"The subnet ID from which the IP address is assigned\", \"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}, \"network_id\": {\"format\": \"uuid\", \"type\": \"string\"}, \"qos_policy_id\": {\"format\": \"uuid\", \"type\": [\"null\", \"string\"]}}, \"required\": [\"network_id\"], \"type\": [\"null\", \"object\"]}, \"ha\": {\"description\": \"`true` indicates a highly-available router.\\nIt is available when `l3-ha` extension is enabled.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"name\": {\"description\": \"Human-readable name of the resource.\", \"type\": \"string\"}, \"routes\": {\"description\": \"The extra routes configuration for L3 router.\\nA list of dictionaries with `destination` and `nexthop` parameters.\\nIt is available when `extraroute` extension is enabled.\\nDefault is an empty list (`[]`).\", \"items\": {\"properties\": {\"destination\": {\"type\": \"string\"}, \"nexthop\": {\"type\": \"string\"}}, \"type\": \"object\"}, \"type\": \"array\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
