...
pub struct Request<'a> {
    #[builder(private, setter(into, name = "_default_security_group_rule"))]
    pub(crate) default_security_group_rule: BTreeMap<Cow<'a, str>, Value>,
...
impl<'a> RequestBuilder<'a> {
    pub fn default_security_group_rule<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("default-security-group-rules/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the default-security-group-rules/id:put operation\", \"properties\": {\"default_security_group_rule\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .default_security_group_rule(BTreeMap::<String, Value>::new().into_iter())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/default-security-group-rules/{id}", id = "id",));
