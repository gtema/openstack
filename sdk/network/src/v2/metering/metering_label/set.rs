...
impl<'a> RequestBuilder<'a> {
    pub fn metering_label<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("metering/metering-labels/{id}", id = self.id.as_ref(),).into()
    }
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            "metering_label",
            serde_json::to_value(&self.metering_label)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the metering/metering-labels/id:put operation\", \"properties\": {\"metering_label\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .metering_label(BTreeMap::<String, Value>::new().into_iter())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/metering/metering-labels/{id}", id = "id",));

            then.status(200)
                .header("content-type", "application/json")
                .json_body(json!({ "metering_label": {} }));
        });
