...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("metering/metering-label-rules/{id}", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the metering/metering-label-rules/id:put operation\", \"properties\": {\"metering_label_rule\": {\"properties\": {\"destination_ip_prefix\": {\"type\": \"string\"}, \"source_ip_prefix\": {\"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/metering/metering-label-rules/{id}", id = "id",));
