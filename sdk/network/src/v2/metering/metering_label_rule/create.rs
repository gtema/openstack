...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the metering/metering-label-rules:post operation\", \"properties\": {\"metering_label_rule\": {\"description\": \"A `metering_label_rule` object.\", \"properties\": {\"destination_ip_prefix\": {\"type\": \"string\"}, \"direction\": {\"description\": \"Ingress or egress, which is the direction in\\nwhich the metering rule is applied.\", \"enum\": [\"egress\", \"ingress\"], \"type\": \"string\"}, \"excluded\": {\"description\": \"Indicates whether to count the traffic of a specific IP address with the\\n`remote_ip_prefix`, `source_ip_prefix`, or `destination_ip_prefix`\\nvalues. Default is `false`.\", \"type\": [\"boolean\", \"string\"]}, \"metering_label_id\": {\"description\": \"The metering label ID associated with this\\nmetering rule.\", \"format\": \"uuid\", \"type\": \"string\"}, \"remote_ip_prefix\": {\"description\": \"(deprecated) The source IP prefix that is matched by this metering rule. By\\nsource IP prefix, one should read the internal/private IPs used in\\nOpenStack.\", \"type\": \"string\"}, \"source_ip_prefix\": {\"type\": \"string\"}, \"tenant_id\": {\"maxLength\": 255, \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
