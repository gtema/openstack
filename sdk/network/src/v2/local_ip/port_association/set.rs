...
impl<'a> RequestBuilder<'a> {
    pub fn port_association<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
    {
        self.port_association
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the local_ips/local_ip_id/port_associations/id:put operation\", \"properties\": {\"port_association\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
