...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the flavors/flavor_id/service_profiles:post operation\", \"properties\": {\"service_profile\": {\"description\": \"A `service_profile` object.\", \"properties\": {\"id\": {\"description\": \"The UUID of the service profile.\", \"format\": \"uuid\", \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .service_profile(ServiceProfileBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
