...
pub struct Request<'a> {
    #[builder(private, setter(into, name = "_service_profile"))]
    pub(crate) service_profile: BTreeMap<Cow<'a, str>, Value>,
...
impl<'a> RequestBuilder<'a> {
    pub fn service_profile<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "flavors/{flavor_id}/service_profiles/{id}",
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            "service_profile",
            serde_json::to_value(&self.service_profile)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the flavors/flavor_id/service_profiles/id:put operation\", \"properties\": {\"service_profile\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .service_profile(BTreeMap::<String, Value>::new().into_iter())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            ...
            then.status(200)
                ...
                .json_body(json!({ "service_profile": {} }));
        });
