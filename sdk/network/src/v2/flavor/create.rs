...
pub struct Flavor<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(into))]
    pub(crate) service_profiles: Option<Vec<Cow<'a, str>>>,

    /// Service type for the flavor. Example: FIREWALL.
    #[serde(skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(into))]
    pub(crate) service_type: Option<Cow<'a, str>>,
}
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the flavors:post operation\", \"properties\": {\"flavor\": {\"description\": \"A `flavor` object.\", \"properties\": {\"description\": {\"description\": \"The human-readable description for the flavor.\", \"maxLength\": 1024, \"type\": [\"null\", \"string\"]}, \"enabled\": {\"description\": \"Indicates whether the flavor is enabled or not. Default is true.\", \"type\": [\"boolean\", \"null\", \"string\"]}, \"name\": {\"description\": \"Name of the flavor.\", \"type\": \"string\"}, \"service_profiles\": {\"items\": {\"format\": \"uuid\", \"type\": \"string\"}, \"type\": \"array\"}, \"service_type\": {\"description\": \"Service type for the flavor. Example: FIREWALL.\", \"type\": \"string\"}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .flavor(FlavorBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
