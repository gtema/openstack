...
impl<'a> RequestBuilder<'a> {
    pub fn next_provider<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "flavors/{flavor_id}/next_providers/{id}",
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("next_provider", serde_json::to_value(&self.next_provider)?);
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the flavors/flavor_id/next_providers/id:put operation\", \"properties\": {\"next_provider\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .next_provider(BTreeMap::<String, Value>::new().into_iter())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
