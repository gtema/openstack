...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the agents/agent_id/dhcp-networks:post operation\", \"type\": \"object\"}";
...
mod tests {
    ...
    fn endpoint() {
        ...
        let endpoint = Request::builder().agent_id("agent_id").build().unwrap();
