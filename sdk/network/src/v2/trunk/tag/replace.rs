...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the trunks/trunk_id/tags:put operation\", \"properties\": {\"tags\": {\"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/trunks/{trunk_id}/tags", trunk_id = "trunk_id",));
