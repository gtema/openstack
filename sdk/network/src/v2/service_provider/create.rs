...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        "service-providers".to_string().into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the service-providers:post operation\", \"properties\": {\"service_provider\": {\"properties\": {}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path("/service-providers".to_string());
