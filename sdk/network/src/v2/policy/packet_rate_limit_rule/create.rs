...
pub struct PacketRateLimitRule {
...
pub struct Request<'a> {
    #[builder(setter(into))]
    pub(crate) packet_rate_limit_rule: PacketRateLimitRule,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "policies/{policy_id}/packet_rate_limit_rules",
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            ...
            serde_json::to_value(&self.packet_rate_limit_rule)?,
        );
    ...
    fn response_key(&self) -> Option<Cow<'static, str>> {
        Some("packet_rate_limit_rule".into())
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the policies/policy_id/packet_rate_limit_rules:post operation\", \"properties\": {\"packet_rate_limit_rule\": {\"properties\": {\"direction\": {\"enum\": [\"egress\", \"ingress\"], \"type\": \"string\"}, \"max_burst_kpps\": {\"maximum\": 2147483647, \"minimum\": 0, \"type\": [\"integer\", \"string\"]}, \"max_kpps\": {\"maximum\": 2147483647, \"minimum\": 0, \"type\": [\"integer\", \"string\"]}}, \"type\": \"object\"}}, \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            ...
            then.status(200)
                ...
                .json_body(json!({ "packet_rate_limit_rule": {} }));
        });
