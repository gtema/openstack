...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "subnetpools/{subnetpool_id}/tags",
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the subnetpools/subnetpool_id/tags:put operation\", \"properties\": {\"tags\": {\"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}}, \"type\": \"object\"}";
