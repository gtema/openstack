...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the subnetpools/id/remove_prefixes:put operation\", \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/subnetpools/{id}/remove_prefixes", id = "id",));
