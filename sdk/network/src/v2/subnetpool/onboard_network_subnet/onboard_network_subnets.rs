...
impl<'a> RequestBuilder<'a> {
    /// Add a single header to the Onboard_Network_Subnet.
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the subnetpools/id/onboard_network_subnets:put operation\", \"type\": \"object\"}";
