...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "qos/policies/{policy_id}/minimum_bandwidth_rules/{id}",
            id = self.id.as_ref(),
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            ...
            serde_json::to_value(&self.minimum_bandwidth_rule)?,
        );
    ...
    fn response_key(&self) -> Option<Cow<'static, str>> {
        Some("minimum_bandwidth_rule".into())
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the qos/policies/policy_id/minimum_bandwidth_rules/id:put operation\", \"properties\": {\"minimum_bandwidth_rule\": {\"description\": \"A `minimum_bandwidth_rule` object.\", \"properties\": {\"direction\": {\"description\": \"The direction of the traffic to which the QoS\\nrule is applied, as seen from the point of view\\nof the `port`.\\nValid values are `egress` and `ingress`.\", \"enum\": [\"egress\", \"ingress\"], \"type\": \"string\"}, \"min_kbps\": {\"description\": \"The minimum KBPS (kilobits per second) value which should be available for\\nport.\", \"maximum\": 2147483647, \"minimum\": 0, \"type\": [\"integer\", \"string\"]}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .minimum_bandwidth_rule(MinimumBandwidthRuleBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            ...
            then.status(200)
                ...
                .json_body(json!({ "minimum_bandwidth_rule": {} }));
        });
