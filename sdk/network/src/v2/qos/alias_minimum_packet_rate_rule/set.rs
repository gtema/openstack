...
pub struct AliasMinimumPacketRateRule {
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "qos/alias-minimum-packet-rate-rules/{id}",
            id = self.id.as_ref(),
        )
        .into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the qos/alias-minimum-packet-rate-rules/id:put operation\", \"properties\": {\"alias_minimum_packet_rate_rule\": {\"properties\": {\"direction\": {\"enum\": [\"any\", \"egress\", \"ingress\"], \"type\": \"string\"}, \"min_kpps\": {\"maximum\": 2147483647, \"minimum\": 0, \"type\": [\"integer\", \"string\"]}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .alias_minimum_packet_rate_rule(
                    AliasMinimumPacketRateRuleBuilder::default()
                        .build()
                        .unwrap()
                )
                .build()
