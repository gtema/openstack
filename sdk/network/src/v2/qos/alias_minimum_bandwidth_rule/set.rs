...
pub struct AliasMinimumBandwidthRule {
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "qos/alias-minimum-bandwidth-rules/{id}",
            id = self.id.as_ref(),
        )
        .into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the qos/alias-minimum-bandwidth-rules/id:put operation\", \"properties\": {\"alias_minimum_bandwidth_rule\": {\"properties\": {\"direction\": {\"enum\": [\"egress\", \"ingress\"], \"type\": \"string\"}, \"min_kbps\": {\"maximum\": 2147483647, \"minimum\": 0, \"type\": [\"integer\", \"string\"]}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .alias_minimum_bandwidth_rule(
                    AliasMinimumBandwidthRuleBuilder::default().build().unwrap()
                )
                .build()
                .unwrap()
                .service_type(),
