...
pub struct SecurityGroup<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(into))]
    pub(crate) stateful: Option<bool>,
}
...
pub struct Request<'a> {
    /// A `security_group` object.
    #[builder(setter(into))]
    pub(crate) security_group: SecurityGroup<'a>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("security-groups/{id}", id = self.id.as_ref(),).into()
    }
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            "security_group",
            serde_json::to_value(&self.security_group)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the security-groups/id:put operation\", \"properties\": {\"security_group\": {\"description\": \"A `security_group` object.\", \"properties\": {\"description\": {\"description\": \"A human-readable description for the resource.\\nDefault is an empty string.\", \"maxLength\": 255, \"type\": \"string\"}, \"name\": {\"description\": \"Human-readable name of the resource.\", \"maxLength\": 255, \"type\": \"string\"}, \"stateful\": {\"type\": [\"boolean\", \"string\"]}}, \"type\": \"object\"}}, \"type\": \"object\"}";
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .security_group(SecurityGroupBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::Network
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/security-groups/{id}", id = "id",));
