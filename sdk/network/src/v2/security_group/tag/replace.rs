...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "security-groups/{security_group_id}/tags",
            security_group_id = self.security_group_id.as_ref(),
        )
        .into()
    }
...
pub const BODY_SCHEMA: &str = "{\"description\": \"Request of the security-groups/security_group_id/tags:put operation\", \"properties\": {\"tags\": {\"items\": {\"maxLength\": 255, \"type\": \"string\"}, \"type\": \"array\"}}, \"type\": \"object\"}";
