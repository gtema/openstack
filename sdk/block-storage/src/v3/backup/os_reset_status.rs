...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("backups/{id}/action", id = self.id.as_ref(),).into()
    }
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-reset_status\": {\"additionalProperties\": false, \"properties\": {\"status\": {\"format\": \"backup_status\", \"type\": \"string\"}}, \"required\": [\"status\"], \"type\": \"object\"}}, \"required\": [\"os-reset_status\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-reset_status\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/backups/{id}/action", id = "id",));
