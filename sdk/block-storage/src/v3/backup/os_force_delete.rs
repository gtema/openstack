...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-force_delete\": {}}, \"required\": [\"os-force_delete\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-force_delete\"}}";
