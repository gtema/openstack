...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("attachments/{id}/action", id = self.id.as_ref(),).into()
    }
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("os-complete", serde_json::to_value(&self.os_complete)?);
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-complete\": {}}, \"required\": [\"os-complete\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-complete\", \"min-ver\": \"3.44\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/attachments/{id}/action", id = "id",));
