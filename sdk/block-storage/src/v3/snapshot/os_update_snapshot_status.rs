...
pub struct OsUpdateSnapshotStatus<'a> {
    #[serde(skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(into))]
    pub(crate) progress: Option<Cow<'a, str>>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("snapshots/{id}/action", id = self.id.as_ref(),).into()
    }
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            ...
            serde_json::to_value(&self.os_update_snapshot_status)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-update_snapshot_status\": {\"additionalProperties\": false, \"properties\": {\"progress\": {\"format\": \"progress\"}, \"status\": {\"type\": \"string\"}}, \"required\": [\"status\"], \"type\": \"object\"}}, \"required\": [\"os-update_snapshot_status\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-update_snapshot_status\"}}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/snapshots/{id}/action", id = "id",));
