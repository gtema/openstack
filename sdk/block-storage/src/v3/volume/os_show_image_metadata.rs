...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-show_image_metadata\": {}}, \"required\": [\"os-show_image_metadata\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-show_image_metadata\"}}";
