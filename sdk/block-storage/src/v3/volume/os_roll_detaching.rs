...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-roll_detaching\": {}}, \"required\": [\"os-roll_detaching\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-roll_detaching\"}}";
