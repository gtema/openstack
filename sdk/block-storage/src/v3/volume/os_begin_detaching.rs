...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"os-begin_detaching\": {}}, \"required\": [\"os-begin_detaching\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"os-begin_detaching\"}}";
