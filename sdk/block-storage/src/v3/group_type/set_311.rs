...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .group_type(GroupTypeBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::BlockStorage
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/group_types/{id}", id = "id",));
