...
pub struct Request<'a> {
    ...
    _properties: BTreeMap<Cow<'a, str>, Option<Cow<'a, str>>>,
}
impl<'a> Request<'a> {
...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!(
            "group_types/{group_type_id}/group_specs/{id}",
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"maxProperties\": 1, \"minProperties\": 1, \"patternProperties\": {\"^[a-zA-Z0-9-_:.]{1,255}$\": {\"maxLength\": 255, \"type\": [\"null\", \"string\"]}}, \"type\": \"object\", \"x-openstack\": {\"min-ver\": \"3.11\"}}";
