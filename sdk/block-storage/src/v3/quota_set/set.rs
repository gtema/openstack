...
impl<'a> RequestBuilder<'a> {
    /// A `quota_set` object.
    pub fn quota_set<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"quota_set\": {\"description\": \"A `quota_set` object.\", \"format\": \"quota_set\", \"minProperties\": 1, \"type\": \"object\"}}, \"required\": [\"quota_set\"], \"type\": \"object\"}";
