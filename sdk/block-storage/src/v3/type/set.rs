...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("types/{id}", id = self.id.as_ref(),).into()
    }
...
mod tests {
    ...
    fn test_service_type() {
        assert_eq!(
            Request::builder()
                .volume_type(VolumeTypeBuilder::default().build().unwrap())
                .build()
                .unwrap()
                .service_type(),
            ServiceType::BlockStorage
