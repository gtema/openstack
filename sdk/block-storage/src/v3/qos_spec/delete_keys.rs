...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("keys", serde_json::to_value(&self.keys)?);
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"keys\": {\"items\": {\"maxLength\": 255, \"minLength\": 1, \"type\": \"string\"}, \"type\": \"array\", \"uniqueItems\": true}}, \"required\": [\"keys\"], \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::PUT)
                .path(format!("/qos-specs/{id}/delete_keys", id = "id",));
