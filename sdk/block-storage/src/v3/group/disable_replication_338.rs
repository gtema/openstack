...
pub struct Request<'a> {
    #[builder(private, setter(into, name = "_disable_replication"))]
    pub(crate) disable_replication: BTreeMap<Cow<'a, str>, Value>,
...
impl<'a> RequestBuilder<'a> {
    pub fn disable_replication<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            "disable_replication",
            serde_json::to_value(&self.disable_replication)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"disable_replication\": {\"type\": \"object\"}}, \"required\": [\"disable_replication\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"disable_replication\", \"min-ver\": \"3.38\"}}";
