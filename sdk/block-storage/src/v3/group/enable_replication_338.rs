...
pub struct Request<'a> {
    #[builder(private, setter(into, name = "_enable_replication"))]
    pub(crate) enable_replication: BTreeMap<Cow<'a, str>, Value>,
...
impl<'a> RequestBuilder<'a> {
    pub fn enable_replication<I, K, V>(&mut self, iter: I) -> &mut Self
    where
        I: Iterator<Item = (K, V)>,
        K: Into<Cow<'a, str>>,
        V: Into<Value>,
...
impl RestEndpoint for Request<'_> {
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push(
            "enable_replication",
            serde_json::to_value(&self.enable_replication)?,
        );
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"enable_replication\": {\"type\": \"object\"}}, \"required\": [\"enable_replication\"], \"type\": \"object\", \"x-openstack\": {\"action-name\": \"enable_replication\", \"min-ver\": \"3.38\"}}";
