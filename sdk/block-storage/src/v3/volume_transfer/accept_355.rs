...
impl RestEndpoint for Request<'_> {
    ...
    fn endpoint(&self) -> Cow<'static, str> {
        format!("volume-transfers/{id}/accept", id = self.id.as_ref(),).into()
    }
    ...
    fn body(&self) -> Result<Option<(&'static str, Vec<u8>)>, BodyError> {
        ...
        params.push("accept", serde_json::to_value(&self.accept)?);
...
pub const BODY_SCHEMA: &str = "{\"additionalProperties\": false, \"properties\": {\"accept\": {\"additionalProperties\": false, \"properties\": {\"auth_key\": {\"type\": [\"integer\", \"string\"]}}, \"required\": [\"auth_key\"], \"type\": \"object\"}}, \"required\": [\"accept\"], \"type\": \"object\"}";
    ...
    fn endpoint() {
        ...
        let mock = server.mock(|when, then| {
            when.method(httpmock::Method::POST)
                .path(format!("/volume-transfers/{id}/accept", id = "id",));
