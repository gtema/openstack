...
//! Show AvailabilityZone command
//!
//! Wraps invoking of the `v2/lbaas/availabilityzones/{availabilityzone_id}` with `GET` method
...
impl AvailabilityZoneCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        op.output_single::<response::get::AvailabilityZoneResponse>(data.clone())?;
