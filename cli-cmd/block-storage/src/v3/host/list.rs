...
//! List Hosts command
//!
//! Wraps invoking of the `v3/os-hosts` with `GET` method
...
impl HostsCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let op = OutputProcessor::from_args(parsed_args, Some("block-storage.host"), Some("list"));
        ...
        op.output_list::<response::list::HostResponse>(data.clone())?;
