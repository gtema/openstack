...
//! Show Encryption command
//!
//! Wraps invoking of the `v3/volumes/{volume_id}/encryption/{id}` with `GET` method
...
use openstack_types::block_storage::v3::volume::encryption::response;
...
impl EncryptionCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        info!("Show Encryption");

        let op = OutputProcessor::from_args(
            parsed_args,
            Some("block-storage.volume/encryption"),
            Some("show"),
        );
        ...
        op.output_single::<response::get::EncryptionResponse>(data.clone())?;
