...
//! Create VolumeTransfer command [microversion = 3.0]
//!
...
use openstack_sdk::api::block_storage::v3::volume_transfer::create_30;
...
impl VolumeTransferCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut transfer_builder = create_30::TransferBuilder::default();
        ...
        op.output_single::<response::create::VolumeTransferResponse>(data.clone())?;
