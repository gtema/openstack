...
//! Set QuotaClassSet command [microversion = 2.1]
//!
...
impl QuotaClassSetCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        ep_builder.quota_class_set(
            quota_class_set_builder
                .build()
        ...
        op.output_single::<response::set_21::QuotaClassSetResponse>(data.clone())?;
