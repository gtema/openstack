...
use openstack_sdk::api::compute::v2::server::remove_floating_ip;
...
#[derive(Args)]
#[command(about = "Remove (Disassociate) Floating Ip (removeFloatingIp Action) (DEPRECATED)")]
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = remove_floating_ip::Request::builder();
        ...
        let mut remove_floating_ip_builder = remove_floating_ip::RemoveFloatingIpBuilder::default();
