...
#[derive(Args)]
#[command(about = "Get Serial Console (os-getSerialConsole Action) (DEPRECATED)")]
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut os_get_serial_console_builder =
            os_get_serial_console::OsGetSerialConsoleBuilder::default();

        let tmp = match &args._type {
            Type::Serial => os_get_serial_console::Type::Serial,
        };
        ...
        op.output_single::<response::os_get_serial_console::ServerResponse>(data.clone())?;
