...
use openstack_sdk::api::compute::v2::server::add_fixed_ip;
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Add (Associate) Fixed Ip (addFixedIp Action) (DEPRECATED)")]
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut ep_builder = add_fixed_ip::Request::builder();
        ...
        let mut add_fixed_ip_builder = add_fixed_ip::AddFixedIpBuilder::default();
