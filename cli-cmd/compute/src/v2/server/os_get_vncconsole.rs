...
#[derive(Args)]
#[command(about = "Get VNC Console (os-getVNCConsole Action) (DEPRECATED)")]
...
impl ServerCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        let mut os_get_vncconsole_builder = os_get_vncconsole::OsGetVncconsoleBuilder::default();

        let tmp = match &args._type {
            Type::Novnc => os_get_vncconsole::Type::Novnc,
            Type::Xvpvnc => os_get_vncconsole::Type::Xvpvnc,
        };
        ...
        op.output_single::<response::os_get_vncconsole::ServerResponse>(data.clone())?;
