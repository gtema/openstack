...
//! Set Service command [microversion = 2.11]
//!
...
use openstack_sdk::api::compute::v2::service::set_211;
...
/// itemNotFound(404)
#[derive(Args)]
#[command(about = "Update Compute Service (microversion = 2.11)")]
...
impl ServiceCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        ep_builder.header(
            ...
            http::header::HeaderValue::from_static("compute 2.11"),
        );
        ...
        op.output_single::<response::set_20_a::ServiceResponse>(data.clone())
            .or_else(|_| op.output_single::<response::set_20_b::ServiceResponse>(data.clone()))?;
