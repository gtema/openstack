...
//!
//! Wraps invoking of the `v2.0/flavors/{flavor_id}/service_profiles` with `GET` method
...
use openstack_sdk::api::network::v2::flavor::service_profile::list;
...
impl ServiceProfilesCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        op.output_list::<response::list::ServiceProfileResponse>(data.clone())?;
