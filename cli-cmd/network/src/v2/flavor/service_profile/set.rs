...
//!
//! Wraps invoking of the `v2.0/flavors/{flavor_id}/service_profiles/{id}` with `PUT` method
...
use openstack_sdk::api::network::v2::flavor::service_profile::set;
use openstack_types::network::v2::flavor::service_profile::response;
...
pub struct ServiceProfileCommand {
    ...
    service_profile: Vec<(String, Value)>,
}
...
impl ServiceProfileCommand {
    ...
    pub async fn take_action<C: CliArgs>(
        ...
        ep_builder.service_profile(self.service_profile.iter().cloned());
        ...
        op.output_single::<response::set::ServiceProfileResponse>(data.clone())?;
