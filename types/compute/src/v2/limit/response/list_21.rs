...
pub struct Absolute {
    #[serde(rename = "maxImageMeta")]
    pub max_image_meta: i32,
    ...
    pub max_security_group_rules: i32,
    #[serde(rename = "maxSecurityGroups")]
    pub max_security_groups: i32,
    ...
    pub max_total_floating_ips: i32,
    ...
    pub total_floating_ips_used: i32,
    ...
    pub total_security_groups_used: i32,
