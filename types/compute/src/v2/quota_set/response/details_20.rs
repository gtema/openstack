...
pub struct QuotaSetResponse {
    ...
    #[structable(serialize)]
    pub injected_file_content_bytes: InjectedFileContentBytes,
    ...
    /// **Available until version 2.56**
    #[structable(serialize)]
    pub injected_file_path_bytes: InjectedFilePathBytes,
    ...
    /// **Available until version 2.56**
    #[structable(serialize)]
    pub injected_files: InjectedFiles,
    ...
    /// **Available until version 2.35**
    #[structable(serialize)]
    pub security_group_rules: SecurityGroupRules,
...
///
/// **Available until version 2.56**
/// `InjectedFileContentBytes` type
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct InjectedFileContentBytes {
    pub in_use: i32,
    pub limit: i32,
    pub reserved: i32,
}
...
///
/// **Available until version 2.56**
/// `InjectedFilePathBytes` type
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct InjectedFilePathBytes {
    pub in_use: i32,
    pub limit: i32,
    pub reserved: i32,
}
