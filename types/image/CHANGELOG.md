...
## [0.22.8](https://github.com/gtema/openstack/compare/openstack-types-image-v0.22.7...openstack-types-image-v0.22.8) - 2026-07-23

### Added

- Adapt codegen to use min ver suffix ([#1870](https://github.com/gtema/openstack/pull/1870))

## [0.22.7](https://github.com/gtema/openstack/compare/openstack-types-image-v0.1.0...openstack-types-image-v0.22.7) - 2026-06-01

### Other

- *(ci)* Changes necessary for making initial release ([#1768](https://github.com/gtema/openstack/pull/1768))

## [0.1.0](https://github.com/gtema/openstack/releases/tag/openstack-types-image-v0.1.0) - 2026-05-14
