...
//! Response type for the PUT `routers/{router_id}/l3-agents/{id}` operation
...
pub struct L3AgentResponse(BTreeMap<String, Value>);

impl StructTable for L3AgentResponse {
