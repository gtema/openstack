...
//! Response type for the GET `service_statuses/{service_id}` operation
...
pub struct ServiceStatusResponse(BTreeMap<String, Value>);

impl StructTable for ServiceStatusResponse {
