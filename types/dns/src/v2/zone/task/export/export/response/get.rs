...
//! Response type for the GET `zones/tasks/exports/{export_id}/export` operation
...
pub struct ExportResponse(BTreeMap<String, Value>);

impl StructTable for ExportResponse {
