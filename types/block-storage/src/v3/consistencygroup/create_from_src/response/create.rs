...
//! Response type for the POST `consistencygroups/create_from_src` operation
...
pub struct CreateFromSrcResponse(BTreeMap<String, Value>);

impl StructTable for CreateFromSrcResponse {
