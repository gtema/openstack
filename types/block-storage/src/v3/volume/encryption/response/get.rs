...
//! Response type for the GET `volumes/{volume_id}/encryption/{id}` operation
...
pub struct EncryptionResponse(BTreeMap<String, Value>);

impl StructTable for EncryptionResponse {
