...
//! Response type for the GET `users/{user_id}/OS-OAUTH1/access_tokens/{access_token_id}/roles/{role_id}` operation
...
pub struct RoleResponse(BTreeMap<String, Value>);

impl StructTable for RoleResponse {
