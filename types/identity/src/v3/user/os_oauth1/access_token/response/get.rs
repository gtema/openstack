...
//! Response type for the GET `users/{user_id}/OS-OAUTH1/access_tokens/{access_token_id}` operation
...
pub struct AccessTokenResponse(BTreeMap<String, Value>);

impl StructTable for AccessTokenResponse {
