...
//! Response type for the GET `OS-INHERIT/projects/{project_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects` operation
...
pub struct InheritedToProjectResponse(BTreeMap<String, Value>);

impl StructTable for InheritedToProjectResponse {
