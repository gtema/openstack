...
//! Response type for the GET `OS-EP-FILTER/projects/{project_id}/endpoint_groups` operation
...
pub struct EndpointGroupResponse(BTreeMap<String, Value>);

impl StructTable for EndpointGroupResponse {
