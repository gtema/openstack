...
//! Response type for the POST `OS-OAUTH1/request_token` operation
...
pub struct RequestTokenResponse(BTreeMap<String, Value>);

impl StructTable for RequestTokenResponse {
